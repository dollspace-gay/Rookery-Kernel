---
title: "Tier-3: fs/proc/proc-misc — top-level read-only /proc files (cmdline, version, uptime, loadavg, meminfo, stat, cpuinfo, interrupts, diskstats, partitions, swaps, buddyinfo, zoneinfo, vmstat, vmallocinfo, softirqs, consoles, devices)"

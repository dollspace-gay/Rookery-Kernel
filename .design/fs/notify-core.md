# Tier-3: fs/notify/fsnotify.c + fs/notify/notification.c — fsnotify core dispatch + event queue
...
upstream-paths:
  - fs/notify/fsnotify.c (~728 lines)
  - fs/notify/notification.c (~193 lines)

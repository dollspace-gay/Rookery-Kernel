# Tier-3: fs/aio.c — POSIX-AIO / kernel-aio
...
upstream-paths:
  - fs/aio.c (~2499 lines)
  - include/uapi/linux/aio_abi.h (IOCB_CMD_*, struct iocb, struct io_event, aio_context_t)
  - include/linux/aio.h (kiocb_set_cancel_fn, exit_aio prototypes)
-->

# Tier-3: fs/ntfs3/super.c — NTFS-3 superblock + mount
...
upstream-paths:
  - fs/ntfs3/super.c (~1997 lines)
  - fs/ntfs3/ntfs.h
  - fs/ntfs3/ntfs_fs.h
  - fs/ntfs3/fslog.c ($LogFile replay)
  - fs/ntfs3/fsntfs.c ($MFT helpers + ntfs_set_state)
  - fs/ntfs3/inode.c (ntfs_iget5 / ntfs_evict_inode)
  - fs/ntfs3/bitmap.c (wnd_init / wnd_close)
-->

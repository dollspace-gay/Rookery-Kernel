# Tier-3: fs/btrfs/raid56.c — Btrfs RAID5/RAID6 stripe engine
...
upstream-paths:
  - fs/btrfs/raid56.c (~3044 lines)
  - fs/btrfs/raid56.h
  - include/linux/raid/xor.h
  - include/linux/raid/pq.h (raid6_call.gen_syndrome / raid6_datap_recov / raid6_2data_recov)
-->
...
- Whether to expose a per-mount `nosub_stripe_write` option that refuses sub-stripe writes if csum loading fails (instead of upstream's warn-and-continue).

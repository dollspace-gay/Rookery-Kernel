# Tier-3: fs/ceph/super.c — Ceph fs client superblock + mount
...
upstream-paths:
  - fs/ceph/super.c (~1716 lines)
  - fs/ceph/super.h
  - fs/ceph/mds_client.c (mdsc lifetime hooks)
  - include/linux/ceph/libceph.h (ceph_client, ceph_options)
  - include/linux/ceph/mon_client.h (ceph_monc_*, monmap)
  - include/linux/ceph/osd_client.h (ceph_osdc_*)
  - include/uapi/linux/magic.h (CEPH_SUPER_MAGIC)
-->

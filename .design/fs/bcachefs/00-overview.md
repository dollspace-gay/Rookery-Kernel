# Tier-2: fs/bcachefs — bcachefs (next-gen COW + RAID + replicas + tiering + checksum + erasure-coding + btree)
...
## Out of Scope
Implementation code; 32-bit-only paths; bcachefs-tools userspace.

# Tier-3: mm/page-writeback.c — Dirty-page throttle and writeback bandwidth control
...
upstream-paths:
  - mm/page-writeback.c (~3110 lines)
  - include/linux/writeback.h
  - include/linux/backing-dev.h
  - include/linux/backing-dev-defs.h
  - include/uapi/linux/sysctl.h (vm.dirty_background_ratio, vm.dirty_ratio,
    vm.dirty_background_bytes, vm.dirty_bytes, vm.dirty_writeback_centisecs,
    vm.dirty_expire_centisecs, vm.laptop_mode, vm.highmem_is_dirtyable)
  - Documentation/admin-guide/sysctl/vm.rst
  - fs/fs-writeback.c (wb_workfn, wb_writeback_work — referenced; full file Out of Scope)
-->

# Tier-3: mm/workingset.c — Refault distance & LRU activation
...
upstream-paths:
  - mm/workingset.c (~845 lines)
  - include/linux/swap.h (workingset_eviction / workingset_refault declarations)
  - include/linux/mmzone.h (nonresident_age, WORKINGSET_* node counters)
-->

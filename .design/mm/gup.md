# Tier-3: mm/gup.c — get_user_pages() family
...
upstream-paths:
  - mm/gup.c (~3557 lines)
  - include/linux/mm.h (FOLL_* flags, pin/get refcount helpers)
  - include/linux/mm_types.h (enum FOLL_*, GUP_PIN_COUNTING_BIAS, MMF_HAS_PINNED)

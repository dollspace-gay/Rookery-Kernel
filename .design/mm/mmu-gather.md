# Tier-3: mm/mmu_gather.c — TLB flush batching (mmu_gather)
...
upstream-paths:
  - mm/mmu_gather.c (~555 lines)
  - include/asm-generic/tlb.h (struct mmu_gather, struct mmu_gather_batch, struct mmu_table_batch, encoded_page helpers)
  - arch/<arch>/include/asm/tlb.h (per-arch tlb_flush, tlb_start_vma, tlb_end_vma, __tlb_remove_table)
-->

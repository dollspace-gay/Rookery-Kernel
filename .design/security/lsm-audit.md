# Tier-3: security/lsm_audit.c — common LSM audit helpers
...
upstream-paths:
  - security/lsm_audit.c (~457 lines)
  - include/linux/lsm_audit.h (struct common_audit_data, struct lsm_network_audit, struct lsm_ioctlop_audit, struct lsm_ibpkey_audit, struct lsm_ibendport_audit, LSM_AUDIT_DATA_* types)
  - include/linux/audit.h (audit_log_start, audit_log_end, audit_log_format, audit_log_untrustedstring, audit_log_d_path, audit_log_n_hex, AUDIT_AVC)
  - include/linux/lsm_hooks.h (lockdown_reasons[])
-->

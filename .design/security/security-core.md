# Tier-3: security/security.c — LSM core (hook dispatch + composite blobs)

<!--
baseline-commit: 27a26ccfd528da725a999ea1e3102503c61eb655
baseline-version: 7.1.0-rc2
status: draft
parent: security/00-overview.md
upstream-paths:
  - security/security.c (~5718 lines)
  - security/lsm_init.c (lsm_prepare / lsm_init_single / security_add_hooks / early_security_init / security_init)
  - security/lsm.h
  - include/linux/lsm_hooks.h (struct lsm_id, struct lsm_blob_sizes, struct lsm_static_call, struct lsm_static_calls_table, struct security_hook_list, struct lsm_info, DEFINE_LSM, DEFINE_EARLY_LSM)
  - include/linux/lsm_hook_defs.h (per-hook LSM_HOOK(RET, DEFAULT, NAME, ...) signatures)
  - include/linux/security.h (per-callsite security_*() prototypes)
  - include/uapi/linux/lsm.h (LSM_ID_* identifiers, struct lsm_ctx)
-->

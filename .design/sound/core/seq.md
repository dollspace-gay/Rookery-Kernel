# Tier-3: sound/core/seq/ — ALSA sequencer (MIDI event routing engine)
...
upstream-paths:
  - sound/core/seq/seq.c (~120 lines — module init/exit)
  - sound/core/seq/seq_clientmgr.c (~2685 lines — client mgmt + /dev/snd/seq fops + dispatch)
  - sound/core/seq/seq_memory.c (~562 lines — cell pool)
  - sound/core/seq/seq_queue.c (~710 lines — per-queue lifecycle)
  - sound/core/seq/seq_ports.c (~720 lines — port + subscribe/unsubscribe)
  - sound/core/seq/seq_fifo.c (~270 lines — per-user-client input FIFO)
  - sound/core/seq/seq_prioq.c (~400 lines — time-ordered priority queue)
  - sound/core/seq/seq_timer.c (~467 lines — per-queue timer wrapper over snd_timer)
  - sound/core/seq/seq_system.c (~199 lines — system client (id 0) + announce port)
  - sound/core/seq/seq_lock.c (~26 lines — snd_use_lock)
  - sound/core/seq/seq_info.c, seq_dummy.c, seq_midi.c, seq_virmidi.c, seq_compat.c (companions)
  - include/sound/seq_kernel.h
  - include/uapi/sound/asequencer.h (struct snd_seq_event, SNDRV_SEQ_IOCTL_*)
-->

# Tier-3: kernel/fork.c — Process / thread creation (fork / vfork / clone / clone3)
...
upstream-paths:
  - kernel/fork.c (~3383 lines)
  - include/linux/sched/task.h (struct kernel_clone_args, kernel_clone, copy_thread)
  - include/uapi/linux/sched.h (struct clone_args, CLONE_* flags, CLONE_ARGS_SIZE_VER*)
  - kernel/pid.c (alloc_pid, pid_namespace integration)
  - kernel/nsproxy.c (copy_namespaces)
  - kernel/cred.c (copy_creds)
  - fs/file.c (dup_fd)
  - fs/fs_struct.c (copy_fs_struct)
  - fs/pidfs.c (pidfs_alloc_file)
-->

# Tier-3: kernel/livepatch/transition.c — Per-task consistency-model transition
...
upstream-paths:
  - kernel/livepatch/transition.c (~731 lines)
  - kernel/livepatch/transition.h
  - include/linux/livepatch.h (KLP_TRANSITION_IDLE/UNPATCHED/PATCHED, TIF_PATCH_PENDING glue)
-->

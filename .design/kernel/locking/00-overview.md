# Tier-3: kernel/locking — locking primitives hub (mutex, spinlock, rwsem, seqlock, RCU)
...
(none — locking primitive set is fully specified by upstream Linux conventions)

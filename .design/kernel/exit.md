# Tier-3: kernel/exit.c — Task termination and reaping
...
upstream-paths:
  - kernel/exit.c (~2003 lines)
  - include/linux/sched.h (exit_state, EXIT_*, TASK_DEAD)
  - include/linux/wait.h (struct wait_opts)
  - include/uapi/linux/wait.h (W*FLAGS, P_*)
-->

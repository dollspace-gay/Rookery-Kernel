# Tier-3: kernel/time/posix-cpu-timers.c — POSIX CPU-time clocks and timers
...
upstream-paths:
  - kernel/time/posix-cpu-timers.c (~1670 lines)
  - kernel/time/posix-timers.h (internal posix_timer_queue_signal / posix_timer_set_common)
  - include/linux/posix-timers.h (posix_cputimers, posix_cputimer_base, cpu_timer)
  - include/linux/sched/cputime.h (task_cputime, thread_group_cputime, task_sched_runtime)
  - include/linux/sched/signal.h (signal_struct::cputimer, ::it[CPUCLOCK_*], ::rlim, ::posix_cputimers)
  - include/uapi/linux/time.h (CLOCK_PROCESS_CPUTIME_ID / _THREAD_CPUTIME_ID / CPUCLOCK_* encodings)
-->

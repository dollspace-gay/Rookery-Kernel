# Tier-3: kernel/trace/ring_buffer.c — Lock-free tracing ring buffer
...
upstream-paths:
  - kernel/trace/ring_buffer.c (~8103 lines)
  - include/linux/ring_buffer.h
  - include/linux/trace_events.h (struct ring_buffer_event)
-->

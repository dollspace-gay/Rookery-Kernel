# Tier-3: kernel/events/hw_breakpoint.c — Hardware-breakpoint subsystem
...
upstream-paths:
  - kernel/events/hw_breakpoint.c (~1025 lines)
  - include/linux/hw_breakpoint.h (enum bp_type_idx, struct arch_hw_breakpoint accessor)
  - include/uapi/linux/hw_breakpoint.h (HW_BREAKPOINT_EMPTY/R/W/RW/X/INVALID, HW_BREAKPOINT_LEN_*)
  - arch/x86/kernel/hw_breakpoint.c (arch glue, DR0..DR3, DR6, DR7)
-->

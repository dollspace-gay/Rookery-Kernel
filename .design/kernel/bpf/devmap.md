# Tier-3: kernel/bpf/devmap.c — BPF devmap (XDP net_device redirect)
...
upstream-paths:
  - kernel/bpf/devmap.c (~1198 lines)
  - include/linux/bpf.h (BPF_MAP_TYPE_DEVMAP, BPF_MAP_TYPE_DEVMAP_HASH, struct bpf_devmap_val)
  - include/uapi/linux/bpf.h (BPF_XDP_DEVMAP, BPF_F_BROADCAST, BPF_F_EXCLUDE_INGRESS)
  - include/linux/netdevice.h (struct net_device, xdp_bulkq, ndo_xdp_xmit)
  - include/net/xdp.h (struct xdp_frame, xdp_do_redirect)
  - include/trace/events/xdp.h (trace_xdp_devmap_xmit, trace_xdp_exception, struct _bpf_dtab_netdev)
-->

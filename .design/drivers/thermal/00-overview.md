# Tier-2: drivers/thermal — thermal framework (thermal_zone + cooling_device + governors + per-driver thermal sensors)
...
## Out of Scope
Implementation code; ARM SoC thermal drivers; 32-bit-only paths.

# Tier-2: drivers/regulator — voltage/current regulator framework (core + per-PMIC drivers + machine + userspace)
...
## Out of Scope
ARM-only SoC PMICs; implementation code; 32-bit-only paths.

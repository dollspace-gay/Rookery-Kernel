# Tier-3: drivers/scsi/sd.c — SCSI disk (sd) upper-level driver
...
upstream-paths:
  - drivers/scsi/sd.c (~4524 lines)
  - drivers/scsi/sd.h
  - drivers/scsi/sd_zbc.c (REPORT ZONES / zone-mgmt for TYPE_ZBC)
  - drivers/scsi/sd_dif.c (T10-PI DIF host integration)
  - include/scsi/scsi_proto.h (READ_6/10/16, WRITE_6/10/16, UNMAP, WRITE_SAME, SYNCHRONIZE_CACHE, ZBC_IN/OUT)
-->

# Tier-2: drivers/iio — Industrial I/O subsystem (sensors: ADC, accel, gyro, magn, prox, ALS, press, temp, hum, color, gas, IMU, dac, light)
...
## Out of Scope
ARM-only SoC sensors; implementation code; 32-bit-only paths.

# Tier-3: drivers/iommu/intel/cache.c — Intel VT-d invalidation cache mgmt API (IOTLB + DEV-IOTLB + PIOTLB + PASID-cache + IEC)
...
upstream-paths:
  ...
  - drivers/iommu/intel/iommu.h (cache flush helpers)
-->

# Tier-3: drivers/iommu/intel/nested.c — Intel VT-d nested-translation backend (vIOMMU 2-stage page-table)
...
upstream-paths:
  ...
  - drivers/iommu/intel/iommu.h (nested fields)
  - drivers/iommu/iommufd/viommu.c (vIOMMU framework that drives nested attach)
  - include/uapi/linux/iommufd.h (IOMMU_HWPT_DATA_VTD_S1)
-->

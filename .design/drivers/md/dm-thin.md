# Tier-3: drivers/md/dm-thin.c — thin-provisioning target (overcommit + COW snapshots + per-pool data/metadata + thin-pool deferred-bio)
...
upstream-paths:
  ...
  - drivers/md/persistent-data/dm-space-map.c
-->

# Tier-2: drivers/clocksource — clocksource + clockevent device drivers (HPET + TSC + KVM-clock + acpi_pm + per-SoC timers)
...
## Out of Scope
ARM SoC timers; implementation code; 32-bit-only paths.

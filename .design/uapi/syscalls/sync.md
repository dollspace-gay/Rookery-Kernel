# Tier-5 syscall: sync(2) — syscall 162
...
upstream-paths:
  - fs/sync.c (SYSCALL_DEFINE0(sync), ksys_sync, sync_filesystems, sync_inodes_one_sb, sync_fs_one_sb)
  - include/linux/writeback.h (writeback_inodes_sb, sync_inodes_sb)
  - arch/x86/entry/syscalls/syscall_64.tbl (162  common  sync)
-->

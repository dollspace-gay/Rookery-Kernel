# Tier-5 syscall: chown(2) — syscall 92
...
upstream-paths:
  - fs/open.c (SYSCALL_DEFINE3(chown), chown_common, do_fchownat)
  - fs/namei.c (user_path_at)
  - fs/attr.c (notify_change, setattr_should_drop_suidgid)
  - include/linux/fs.h (struct iattr, ATTR_UID, ATTR_GID, ATTR_KILL_SUID, ATTR_KILL_SGID)
  - arch/x86/entry/syscalls/syscall_64.tbl (92  common  chown)
-->

# Tier-5 syscall: kcmp(2) — syscall 312
...
upstream-paths:
  - kernel/kcmp.c (SYSCALL_DEFINE5(kcmp), kcmp_ptr, kcmp_epoll_target)
  - include/uapi/linux/kcmp.h (enum kcmp_type, struct kcmp_epoll_slot)
  - kernel/ptrace.c (ptrace_may_access)
  - arch/x86/entry/syscalls/syscall_64.tbl (312  common  kcmp)
-->

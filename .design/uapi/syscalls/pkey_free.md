# Tier-5 syscall: pkey_free(2) — syscall 331
...
upstream-paths:
  - mm/mprotect.c (SYSCALL_DEFINE1(pkey_free), do_pkey_free)
  - arch/x86/mm/pkeys.c (mm_pkey_free, mm_pkey_is_allocated)
  - include/linux/pkeys.h (mm_pkey_free, arch_max_pkey)
  - arch/x86/entry/syscalls/syscall_64.tbl (331  common  pkey_free)
-->

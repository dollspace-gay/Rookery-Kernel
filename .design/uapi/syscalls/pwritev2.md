# Tier-5 syscall: pwritev2(2) — syscall 328
...
upstream-paths:
  - fs/read_write.c (SYSCALL_DEFINE6(pwritev2), do_pwritev2, vfs_pwritev2)
  - include/linux/uio.h (struct iovec, iov_iter, RWF_* flags)
  - include/uapi/linux/fs.h (RWF_DSYNC, RWF_SYNC, RWF_HIPRI, RWF_NOWAIT, RWF_APPEND, RWF_NOAPPEND)
  - arch/x86/entry/syscalls/syscall_64.tbl (328  common  pwritev2)
-->

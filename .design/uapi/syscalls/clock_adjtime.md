# Tier-5 syscall: clock_adjtime(2) — syscall 305
...
upstream-paths:
  - kernel/time/posix-timers.c (sys_clock_adjtime, do_clock_adjtime)
  - kernel/time/timekeeping.c (do_adjtimex for CLOCK_REALTIME)
  - drivers/ptp/ptp_clock.c (posix_clock_ops::clock_adjtime for /dev/ptp*)
  - include/uapi/linux/timex.h (struct timex)
  - arch/*/include/generated/uapi/asm/unistd_64.h (305)
  - Documentation/driver-api/ptp.rst, man clock_adjtime(2)
-->

# Tier-5 syscall: close_range(2) — syscall 436
...
upstream-paths:
  - fs/file.c (SYSCALL_DEFINE3(close_range), __close_range, unshare_fd, close_files)
  - kernel/fork.c (unshare_files, copy_files)
  - include/uapi/linux/close_range.h (CLOSE_RANGE_UNSHARE, CLOSE_RANGE_CLOEXEC)
  - arch/x86/entry/syscalls/syscall_64.tbl (436  common  close_range)
-->

# Tier-5: syscall 252 — ioprio_get(2)
...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`252  common  ioprio_get  sys_ioprio_get`)
  - block/ioprio.c (`SYSCALL_DEFINE2(ioprio_get, ...)`, `get_task_ioprio`)
  - include/uapi/linux/ioprio.h (`IOPRIO_WHO_*`, `IOPRIO_CLASS_*`)
  - kernel/sched/core.c (task_nice → BE-priority derivation)
-->

# Tier-5 syscall: map_shadow_stack(2) — syscall 453
...
upstream-paths:
  - arch/x86/kernel/shstk.c (SYSCALL_DEFINE3(map_shadow_stack), do_map_shadow_stack)
  - arch/x86/include/asm/shstk.h (struct thread_shstk, SHSTK_*)
  - arch/x86/include/uapi/asm/mman.h (SHADOW_STACK_SET_TOKEN, SHADOW_STACK_SET_MARKER)
  - mm/mmap.c (VM_SHADOW_STACK handling)
  - arch/x86/entry/syscalls/syscall_64.tbl (453  common  map_shadow_stack)
-->

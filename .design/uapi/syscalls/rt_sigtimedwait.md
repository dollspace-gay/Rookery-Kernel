# Tier-5 syscall: rt_sigtimedwait(2) — syscall 128
...
upstream-paths:
  - kernel/signal.c (sys_rt_sigtimedwait, do_sigtimedwait)
  - include/linux/signal.h (sigwait helpers)
  - include/uapi/asm-generic/siginfo.h (siginfo_t)
  - include/uapi/linux/time.h (struct timespec)
  - arch/x86/entry/syscalls/syscall_64.tbl (128  common  rt_sigtimedwait)
-->
...
- Signal-delivery internals (`kernel/signal.c::dequeue_signal`,
  `collect_signal` — Tier-3).

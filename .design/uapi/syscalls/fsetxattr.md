# Tier-5: syscall 190 — fsetxattr(2)
...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`190  common  fsetxattr  sys_fsetxattr`)
  - fs/xattr.c (`SYSCALL_DEFINE5(fsetxattr, ...)`, `setxattr`, `__vfs_setxattr_locked`)

# Tier-5 syscall: rseq_slice_yield(2) — forward-looking (ENOSYS in 7.1.0-rc2)
...
upstream-paths:
  - kernel/rseq.c (existing SYSCALL_DEFINE4(rseq, ...) at slot 334;
                   proposed SYSCALL_DEFINE2(rseq_slice_yield, ...))
  - include/uapi/linux/rseq.h (struct rseq, RSEQ_FLAG_*, RSEQ_CS_FLAG_*)
  - kernel/sched/core.c (preemption notifier, cpu-id update)
  - arch/x86/entry/syscalls/syscall_64.tbl (472  common  rseq_slice_yield  (reserved, not wired))
-->

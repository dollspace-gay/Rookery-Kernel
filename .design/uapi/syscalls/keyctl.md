# Tier-5 syscall: keyctl(2) — syscall 250
...
upstream-paths:
  - security/keys/keyctl.c (SYSCALL_DEFINE5(keyctl), keyctl_* dispatch arms)
  - security/keys/persistent.c (keyctl_get_persistent)
  - security/keys/dh.c (keyctl_dh_compute)
  - security/keys/keyring.c (keyctl_keyring_*)
  - include/uapi/linux/keyctl.h (KEYCTL_* commands, struct keyctl_*_params)
  - arch/x86/entry/syscalls/syscall_64.tbl (250  common  keyctl)
  - Documentation/security/keys/core.rst, man keyctl(2), keyctl(3), keyrings(7)
-->

# Tier-5 syscall: mknodat(2) — syscall 259
...
upstream-paths:
  - fs/namei.c (SYSCALL_DEFINE4(mknodat), do_mknodat, vfs_mknod)
  - include/uapi/linux/stat.h (S_IFREG, S_IFCHR, S_IFBLK, S_IFIFO, S_IFSOCK)
  - include/linux/fs.h (inode_operations::mknod)
  - arch/x86/entry/syscalls/syscall_64.tbl (259 common  mknodat)
-->

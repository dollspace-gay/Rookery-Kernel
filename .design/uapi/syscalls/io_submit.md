# Tier-5 syscall: io_submit(2) — syscall 209
...
upstream-paths:
  - fs/aio.c (SYSCALL_DEFINE3(io_submit), io_submit_one, aio_run_iocb)
  - include/uapi/linux/aio_abi.h (struct iocb, IOCB_CMD_*)
  - include/linux/aio.h (struct aio_kiocb)
  - arch/x86/entry/syscalls/syscall_64.tbl (209  common  io_submit)
-->

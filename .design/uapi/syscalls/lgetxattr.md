# Tier-5: syscall 192 — lgetxattr(2)
...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`192  common  lgetxattr  sys_lgetxattr`)
  - fs/xattr.c (`SYSCALL_DEFINE4(lgetxattr, ...)`, `path_getxattr`, `vfs_getxattr`)
  - fs/namei.c (`user_path_at`, no `LOOKUP_FOLLOW`)

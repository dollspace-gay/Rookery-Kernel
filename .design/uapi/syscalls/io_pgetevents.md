# Tier-5 syscall: io_pgetevents(2) — syscall 333
...
upstream-paths:
  - fs/aio.c (SYSCALL_DEFINE6(io_pgetevents), do_io_getevents, read_events)
  - include/uapi/linux/aio_abi.h (struct __aio_sigset)
  - include/linux/aio.h (kioctx)
  - arch/x86/entry/syscalls/syscall_64.tbl (333  64  io_pgetevents)
-->

# Tier-5 syscall: mbind(2) — syscall 237
...
upstream-paths:
  - mm/mempolicy.c (SYSCALL_DEFINE6(mbind), do_mbind, kernel_mbind, queue_pages_range)
  - mm/mempolicy.c (mpol_new, mpol_set_nodemask, mpol_rebind_policy)
  - include/uapi/linux/mempolicy.h (MPOL_*, MPOL_F_*, MPOL_MF_*)
  - include/linux/mempolicy.h (struct mempolicy)
  - arch/x86/entry/syscalls/syscall_64.tbl (237  common  mbind)
-->

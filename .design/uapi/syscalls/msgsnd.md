# Tier-5 syscall: msgsnd(2) — syscall 69
...
upstream-paths:
  - ipc/msg.c (SYSCALL_DEFINE4(msgsnd), do_msgsnd, load_msg, ss_wakeup)
  - ipc/msgutil.c (load_msg, free_msg, copy_msg)
  - include/uapi/linux/msg.h (struct msgbuf, MSGMAX, MSGMNB)
  - include/uapi/linux/ipc.h (IPC_NOWAIT)
  - arch/x86/entry/syscalls/syscall_64.tbl (69  common  msgsnd)
-->

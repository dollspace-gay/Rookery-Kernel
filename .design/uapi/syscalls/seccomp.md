# Tier-5 syscall: seccomp(2) — syscall 317
...
upstream-paths:
  - kernel/seccomp.c (SYSCALL_DEFINE3(seccomp), do_seccomp, seccomp_set_mode_filter)
  - include/uapi/linux/seccomp.h (SECCOMP_SET_MODE_*, SECCOMP_GET_*, SECCOMP_FILTER_FLAG_*)
  - include/uapi/linux/filter.h (struct sock_fprog)
  - kernel/seccomp.c (notify_fd ring + user notification)
  - arch/x86/entry/syscalls/syscall_64.tbl (317  common  seccomp)
-->

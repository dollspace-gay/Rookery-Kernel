# Tier-5 syscall: tgkill(2) — syscall 234
...
upstream-paths:
  - kernel/signal.c (sys_tgkill, do_tkill)
  - include/linux/signal.h (send_sig_info, do_send_specific)
  - include/uapi/asm-generic/siginfo.h (siginfo_t, SI_TKILL)
  - arch/x86/entry/syscalls/syscall_64.tbl (234  common  tgkill)
-->

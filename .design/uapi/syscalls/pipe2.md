...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`293  common  pipe2  sys_pipe2`)
  - fs/pipe.c (`SYSCALL_DEFINE2(pipe2, ...)`, `do_pipe2`, `__do_pipe_flags`, `create_pipe_files`, `alloc_pipe_info`)
  - include/uapi/linux/fcntl.h (`O_CLOEXEC`, `O_NONBLOCK`, `O_DIRECT`, `O_NOTIFICATION_PIPE`)
-->

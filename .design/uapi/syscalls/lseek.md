...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`8  common  lseek  sys_lseek`)
  - fs/read_write.c (`SYSCALL_DEFINE3(lseek, ...)`, `ksys_lseek`, `vfs_llseek`, `default_llseek`, `generic_file_llseek`, `no_seek_end_llseek`, `noop_llseek`)
  - include/uapi/linux/fs.h (`SEEK_SET`, `SEEK_CUR`, `SEEK_END`, `SEEK_DATA`, `SEEK_HOLE`, `SEEK_MAX`)
-->

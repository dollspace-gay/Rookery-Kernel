...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`89  common  readlink  sys_readlink`)
  - fs/stat.c (`SYSCALL_DEFINE3(readlink, ...)`, `do_readlinkat`, `vfs_readlink`)
  - fs/namei.c (`page_readlink`, `simple_readlink`, `__vfs_get_link`)

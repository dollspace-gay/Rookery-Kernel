# Tier-5 syscall: set_robust_list(2) — syscall 273
...
upstream-paths:
  ...
  - kernel/futex/core.c (exit_robust_list, handle_futex_death)
  - include/uapi/linux/futex.h (struct robust_list_head, struct robust_list)
  - include/linux/sched.h (task_struct::robust_list)
  - arch/x86/entry/syscalls/syscall_64.tbl (273 common set_robust_list)
-->

# Tier-5 syscall: pause(2) — syscall 34
...
upstream-paths:
  ...
  - kernel/sched/core.c (schedule(); TASK_INTERRUPTIBLE)
  - kernel/signal.c (signal_pending)
  - arch/x86/entry/syscalls/syscall_64.tbl (34 common pause)
  - man pause(2)
-->

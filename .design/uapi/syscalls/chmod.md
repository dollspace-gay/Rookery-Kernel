# Tier-5 syscall: chmod(2) — syscall 90
...
upstream-paths:
  - fs/open.c (SYSCALL_DEFINE2(chmod), do_fchmodat, chmod_common)
  - fs/namei.c (user_path_at_empty, path resolution)
  - fs/attr.c (notify_change, chown_common companion path)
  - include/linux/fs.h (struct iattr, ATTR_MODE)
  - arch/x86/entry/syscalls/syscall_64.tbl (90  common  chmod)
-->

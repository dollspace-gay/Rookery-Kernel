# Tier-5 syscall: listmount(2) — syscall 458
...
upstream-paths:
  - fs/namespace.c (SYSCALL_DEFINE4(listmount), do_listmount)
  - include/uapi/linux/mount.h (struct mnt_id_req)
  - arch/x86/entry/syscalls/syscall_64.tbl (458  common  listmount)
-->

# Tier-5 syscall: nfsservctl(2) — syscall 180 (DEPRECATED)
...
upstream-paths:
  - kernel/sys_ni.c (COND_SYSCALL(nfsservctl))
  - arch/x86/entry/syscalls/syscall_64.tbl (180  64  nfsservctl)
  - Documentation/filesystems/nfs/ (modern knfsd configuration)
  - /proc/fs/nfsd/* (modern replacement)
-->

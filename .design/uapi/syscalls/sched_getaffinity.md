# Tier-5 syscall: sched_getaffinity(2) — syscall 204
...
upstream-paths:
  - kernel/sched/core.c (SYSCALL_DEFINE3(sched_getaffinity))
  - kernel/sched/syscalls.c (sched_getaffinity helper)
  - kernel/cpumask.c (cpumask_copy)
  - arch/x86/entry/syscalls/syscall_64.tbl (204 common sched_getaffinity)
-->

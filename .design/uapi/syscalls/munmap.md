...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`11  common  munmap  sys_munmap`)
  - mm/mmap.c (`SYSCALL_DEFINE2(munmap, ...)`, `__vm_munmap`, `do_vmi_munmap`, `do_vmi_align_munmap`)
  - mm/util.c (`vm_munmap`)
  - include/linux/mm.h (`VM_SPECIAL`, `VM_DONTEXPAND`, `VM_PFNMAP`)
  - mm/internal.h (`unmap_region`)
-->

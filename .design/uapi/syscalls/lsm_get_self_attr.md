# Tier-5 syscall: lsm_get_self_attr(2) — syscall 459
...
upstream-paths:
  - security/lsm_syscalls.c (SYSCALL_DEFINE4(lsm_get_self_attr), lsm_fill_user_ctx)
  - security/security.c (security_getselfattr, lsm_active_count)
  - include/uapi/linux/lsm.h (struct lsm_ctx, LSM_ATTR_*, LSM_ID_*)
  - include/linux/security.h (security_getselfattr)
  - arch/x86/entry/syscalls/syscall_64.tbl (459  common  lsm_get_self_attr)
-->

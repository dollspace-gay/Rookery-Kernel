# Tier-5 syscall: setreuid(2) — syscall 113
...
upstream-paths:
  - kernel/sys.c (SYSCALL_DEFINE2(setreuid))
  - include/linux/cred.h (struct cred.uid, .euid, .suid)
  - kernel/cred.c (prepare_creds, commit_creds)
  - include/linux/uidgid.h (kuid_t, make_kuid)
  - security/commoncap.c (cap_capable, securebits)
  - arch/x86/entry/syscalls/syscall_64.tbl (113  common  setreuid)
-->

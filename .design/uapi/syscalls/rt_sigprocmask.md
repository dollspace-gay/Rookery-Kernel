# Tier-5 syscall: rt_sigprocmask(2) — syscall 14
...
upstream-paths:
  - kernel/signal.c (sys_rt_sigprocmask, do_sigprocmask, set_current_blocked)
  - include/linux/signal.h (sigset_t, sigprocmask helpers)
  - include/uapi/asm-generic/signal-defs.h (SIG_BLOCK, SIG_UNBLOCK, SIG_SETMASK)
  - arch/x86/entry/syscalls/syscall_64.tbl (14  common  rt_sigprocmask)
-->

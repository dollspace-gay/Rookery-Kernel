# Tier-5 syscall: msgget(2) — syscall 68
...
upstream-paths:
  - ipc/msg.c (SYSCALL_DEFINE2(msgget), newque, msg_security)
  - ipc/util.c (ipcget, ipc_addid, ipcget_new, ipcget_public)
  - ipc/util.h (struct ipc_ids, ipc_namespace)
  - include/uapi/linux/msg.h (struct msqid_ds, MSGMNI, MSGMAX, MSGMNB)
  - include/uapi/linux/ipc.h (IPC_PRIVATE, IPC_CREAT, IPC_EXCL)
  - arch/x86/entry/syscalls/syscall_64.tbl (68  common  msgget)
-->

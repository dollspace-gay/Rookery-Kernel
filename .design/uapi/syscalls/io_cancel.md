# Tier-5 syscall: io_cancel(2) — syscall 210
...
upstream-paths:
  - fs/aio.c (SYSCALL_DEFINE3(io_cancel, ...))
  - include/uapi/linux/aio_abi.h (struct iocb, struct io_event)
  - arch/x86/entry/syscalls/syscall_64.tbl (210  common  io_cancel)
-->

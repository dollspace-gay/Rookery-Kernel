# Tier-5 syscall: syslog(2) — syscall 103
...
upstream-paths:
  - kernel/printk/printk.c (SYSCALL_DEFINE3(syslog), do_syslog, devkmsg_read)
  - include/linux/syslog.h (SYSLOG_ACTION_*)
  - include/uapi/linux/capability.h (CAP_SYSLOG, CAP_SYS_ADMIN)
  - arch/x86/entry/syscalls/syscall_64.tbl (103 common syslog)
-->

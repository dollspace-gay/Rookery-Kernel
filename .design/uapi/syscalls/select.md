# Tier-5 syscall: select(2) — syscall 23
...
upstream-paths:
  - fs/select.c (SYSCALL_DEFINE5(select), kern_select, core_sys_select, do_select)
  - include/uapi/linux/posix_types.h (fd_set, FD_SETSIZE)
  - include/uapi/linux/time.h (struct timeval)
  - arch/x86/entry/syscalls/syscall_64.tbl (23  common  select)
-->

# Tier-5 syscall: file_getattr(2) — syscall 467
...
upstream-paths:
  - fs/inode.c (SYSCALL_DEFINE5(file_getattr), do_file_getattr)
  - fs/ioctl.c (FS_IOC_FSGETXATTR — predecessor)
  - include/uapi/linux/fs.h (struct file_attr, FS_XFLAG_*)
  - include/linux/file_attr.h (internal fileattr struct)
  - arch/x86/entry/syscalls/syscall_64.tbl (467  common  file_getattr)
-->

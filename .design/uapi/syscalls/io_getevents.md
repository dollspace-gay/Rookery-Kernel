# Tier-5 syscall: io_getevents(2) — syscall 208
...
upstream-paths:
  - fs/aio.c (SYSCALL_DEFINE5(io_getevents), do_io_getevents, read_events, aio_read_events_ring)
  - include/uapi/linux/aio_abi.h (struct io_event, aio_context_t)
  - include/linux/aio.h (kioctx, aio_ring, aio_kiocb)
  - arch/x86/entry/syscalls/syscall_64.tbl (208  64  io_getevents)
-->

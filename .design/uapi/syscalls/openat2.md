...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`437  common  openat2  sys_openat2`)
  - fs/open.c (`SYSCALL_DEFINE4(openat2, ...)`, `do_sys_openat2`, `build_open_flags`, `audit_openat2_how`, `OPEN_HOW_SIZE_VER0`, `OPEN_HOW_SIZE_LATEST`)
  - include/uapi/linux/openat2.h (`struct open_how`, `RESOLVE_NO_XDEV`, `RESOLVE_NO_MAGICLINKS`, `RESOLVE_NO_SYMLINKS`, `RESOLVE_BENEATH`, `RESOLVE_IN_ROOT`, `RESOLVE_CACHED`)
  - include/linux/fcntl.h (`VALID_OPEN_FLAGS`, `VALID_RESOLVE_FLAGS`, `OPEN_HOW_SIZE_VER0=24`)
  - fs/namei.c (`LOOKUP_NO_XDEV`, `LOOKUP_NO_MAGICLINKS`, `LOOKUP_NO_SYMLINKS`, `LOOKUP_BENEATH`, `LOOKUP_IN_ROOT`, `LOOKUP_CACHED`)
-->

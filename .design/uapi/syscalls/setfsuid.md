# Tier-5 syscall: setfsuid(2) — syscall 122
...
upstream-paths:
  - kernel/sys.c (SYSCALL_DEFINE1(setfsuid))
  - include/linux/cred.h (struct cred.fsuid)
  - kernel/cred.c (prepare_creds, commit_creds)
  - include/linux/uidgid.h (kuid_t, make_kuid)
  - security/security.c (security_task_fix_setuid LSM_SETID_FS)
  - arch/x86/entry/syscalls/syscall_64.tbl (122  common  setfsuid)
-->

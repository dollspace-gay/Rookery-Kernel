# Tier-5 syscall: getcwd(2) — syscall 79
...
upstream-paths:
  - fs/d_path.c (SYSCALL_DEFINE2(getcwd), prepend_path, __d_path)
  - include/linux/fs_struct.h (struct fs_struct, get_fs_pwd)
  - arch/x86/entry/syscalls/syscall_64.tbl (79  common  getcwd)
-->

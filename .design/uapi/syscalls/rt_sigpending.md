# Tier-5 syscall: rt_sigpending(2) — syscall 127
...
upstream-paths:
  - kernel/signal.c (sys_rt_sigpending, do_sigpending)
  - include/linux/signal.h (sigpending_t, sigorsets)
  - include/uapi/asm-generic/signal.h (sigset_t)
  - arch/x86/entry/syscalls/syscall_64.tbl (127  common  rt_sigpending)
-->

...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`332  common  statx  sys_statx`)
  - fs/stat.c (`SYSCALL_DEFINE5(statx, ...)`, `do_statx`, `vfs_statx`, `vfs_getattr`, `cp_statx`)
  - include/uapi/linux/stat.h (`struct statx`, `STATX_*`, `STATX_ATTR_*`)
  - include/uapi/linux/fcntl.h (`AT_*` constants used by statx)
-->

# Tier-5 syscall: getresuid(2) — syscall 118
...
upstream-paths:
  - kernel/sys.c (SYSCALL_DEFINE3(getresuid))
  - include/linux/cred.h (struct cred.uid, .euid, .suid)
  - include/linux/uidgid.h (kuid_t, from_kuid_munged)
  - include/linux/user_namespace.h (current_user_ns)
  - arch/x86/entry/syscalls/syscall_64.tbl (118  common  getresuid)
-->

# Tier-5 syscall: pwrite64(2) — syscall 18
...
upstream-paths:
  - fs/read_write.c (SYSCALL_DEFINE4(pwrite64), do_pwrite, vfs_pwrite)
  - include/linux/fs.h (struct file, f_op->write_iter)
  - arch/x86/entry/syscalls/syscall_64.tbl (18  common  pwrite64)
-->

# Tier-5 syscall: sched_setparam(2) — syscall 142
...
upstream-paths:
  - kernel/sched/syscalls.c (SYSCALL_DEFINE2(sched_setparam))
  - kernel/sched/core.c (__sched_setscheduler, sched_setscheduler internal helper)
  - kernel/sched/rt.c (RT priority validation)
  - include/uapi/linux/sched.h
  - include/uapi/linux/sched/types.h (struct sched_param)
  - arch/x86/entry/syscalls/syscall_64.tbl (142 common sched_setparam)

# Tier-5 syscall: signalfd4(2) — syscall 289
...
upstream-paths:
  - fs/signalfd.c (sys_signalfd4, do_signalfd4, signalfd_dequeue)
  - include/linux/signalfd.h (signalfd_ctx)
  - include/uapi/linux/signalfd.h (signalfd_siginfo, SFD_CLOEXEC, SFD_NONBLOCK)
  - arch/x86/entry/syscalls/syscall_64.tbl (289  common  signalfd4)
-->

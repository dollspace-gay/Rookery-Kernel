# Tier-5 syscall: shmctl(2) — syscall 31
...
upstream-paths:
  - ipc/shm.c (SYSCALL_DEFINE3(shmctl), shmctl_down, shmctl_ipc_info, shmctl_shm_info, shmctl_stat, shmctl_do_lock, shm_destroy)
  - ipc/util.c (ipc_rmid)
  - include/uapi/linux/shm.h (struct shmid_ds, struct shminfo, struct shm_info, SHM_LOCK, SHM_UNLOCK, SHM_STAT, SHM_INFO, SHM_STAT_ANY)
  - include/uapi/linux/ipc.h (IPC_STAT, IPC_SET, IPC_RMID, IPC_INFO)
  - arch/x86/entry/syscalls/syscall_64.tbl (31  common  shmctl)
-->

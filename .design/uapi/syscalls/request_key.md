# Tier-5 syscall: request_key(2) — syscall 249
...
upstream-paths:
  - security/keys/request_key.c (SYSCALL_DEFINE4(request_key), request_key_and_link)
  - security/keys/keyring.c (keyring_search_rcu, search_nested_keyrings)
  - security/keys/process_keys.c (search_process_keyrings)
  - security/keys/keyctl.c (auth_key handling)
  - include/uapi/linux/keyctl.h
  - arch/x86/entry/syscalls/syscall_64.tbl (249  common  request_key)
  - Documentation/security/keys/request-key.rst, man request_key(2), keyrings(7)
-->

# Tier-5 syscall: sched_setaffinity(2) — syscall 203
...
upstream-paths:
  - kernel/sched/core.c (SYSCALL_DEFINE3(sched_setaffinity))
  - kernel/sched/syscalls.c (__sched_setaffinity)
  - kernel/cpumask.c (alloc_cpumask_var, cpumask_copy)
  - include/uapi/linux/sched.h (no UAPI header for cpumask; pointer is opaque)
  - arch/x86/entry/syscalls/syscall_64.tbl (203 common sched_setaffinity)
-->

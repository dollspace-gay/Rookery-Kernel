# Tier-5 syscall: acct(2) — syscall 163
...
upstream-paths:
  - kernel/acct.c (SYSCALL_DEFINE1(acct), acct_process, do_acct_process)
  - include/linux/acct.h (struct acct_v3)
  - include/uapi/linux/acct.h (ACORE / AFORK / ASU flags)
  - arch/x86/entry/syscalls/syscall_64.tbl (163 common acct)
-->

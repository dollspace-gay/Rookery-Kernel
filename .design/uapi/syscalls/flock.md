# Tier-5 syscall: flock(2) — syscall 73
...
upstream-paths:
  - fs/locks.c (SYSCALL_DEFINE2(flock), flock_lock_file, flock_lock_inode_wait, locks_remove_flock)
  - include/linux/fs.h (struct file_lock; FL_FLOCK)
  - include/uapi/asm-generic/fcntl.h (LOCK_SH, LOCK_EX, LOCK_UN, LOCK_NB, LOCK_MAND-deprecated)
  - arch/x86/entry/syscalls/syscall_64.tbl (73  common  flock)
-->

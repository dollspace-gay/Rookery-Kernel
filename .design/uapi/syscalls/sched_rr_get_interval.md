# Tier-5 syscall: sched_rr_get_interval(2) — syscall 148
...
upstream-paths:
  - kernel/sched/syscalls.c (SYSCALL_DEFINE2(sched_rr_get_interval))
  - kernel/sched/rt.c (RR_TIMESLICE; get_rr_interval_rt)
  - kernel/sched/fair.c (get_rr_interval_fair)
  - include/uapi/linux/time.h (struct timespec)
  - arch/x86/entry/syscalls/syscall_64.tbl (148 common sched_rr_get_interval)

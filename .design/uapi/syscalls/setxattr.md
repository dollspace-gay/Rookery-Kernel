...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`188  common  setxattr  sys_setxattr`)
  - fs/xattr.c (`SYSCALL_DEFINE5(setxattr, ...)`, `path_setxattr`, `setxattr`, `do_setxattr`, `__vfs_setxattr_locked`, `__vfs_setxattr_noperm`)
  - fs/namei.c (`user_path_at`, `LOOKUP_FOLLOW`)
  - include/uapi/linux/xattr.h (`XATTR_CREATE`, `XATTR_REPLACE`, `XATTR_NAME_MAX = 255`, `XATTR_SIZE_MAX = 65536`, `XATTR_USER_PREFIX`, `XATTR_TRUSTED_PREFIX`, `XATTR_SECURITY_PREFIX`, `XATTR_SYSTEM_PREFIX`)

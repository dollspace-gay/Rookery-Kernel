# Tier-5 syscall: statmount(2) — syscall 457
...
upstream-paths:
  - fs/namespace.c (SYSCALL_DEFINE4(statmount), do_statmount, statmount_string, statmount_mnt_basic)
  - include/uapi/linux/mount.h (struct mnt_id_req, struct statmount, STATMOUNT_*)
  - arch/x86/entry/syscalls/syscall_64.tbl (457  common  statmount)
-->

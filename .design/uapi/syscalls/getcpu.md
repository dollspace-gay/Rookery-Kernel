# Tier-5 syscall: getcpu(2) — syscall 309
...
upstream-paths:
  - kernel/sys.c (SYSCALL_DEFINE3(getcpu), do_getcpu)
  - arch/x86/entry/vdso/vgetcpu.c (vDSO __vdso_getcpu)
  - arch/x86/include/asm/segment.h (RDPID / RDTSCP scratch encoding)
  - include/uapi/linux/getcpu.h (struct getcpu_cache — opaque)
  - arch/x86/entry/syscalls/syscall_64.tbl (309  common  getcpu)
-->

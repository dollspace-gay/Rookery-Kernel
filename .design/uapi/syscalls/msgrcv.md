# Tier-5 syscall: msgrcv(2) — syscall 70
...
upstream-paths:
  - ipc/msg.c (SYSCALL_DEFINE5(msgrcv), do_msgrcv, find_msg, store_msg)
  - ipc/msgutil.c (store_msg, free_msg)
  - include/uapi/linux/msg.h (struct msgbuf, MSG_NOERROR, MSG_EXCEPT, MSG_COPY)
  - include/uapi/linux/ipc.h (IPC_NOWAIT)
  - arch/x86/entry/syscalls/syscall_64.tbl (70  common  msgrcv)
-->

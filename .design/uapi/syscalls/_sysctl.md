# Tier-5 syscall: _sysctl(2) — syscall 156 (REMOVED)
...
upstream-paths:
  - kernel/sys_ni.c (COND_SYSCALL(sysctl))
  - arch/x86/entry/syscalls/syscall_64.tbl (156  64  _sysctl)
  - Documentation/admin-guide/sysctl/ (modern /proc/sys interface)
  - kernel/sysctl.c (the in-kernel sysctl table, still alive — but only via /proc/sys)
-->

# Tier-5 syscall: sched_yield(2) — syscall 24
...
upstream-paths:
  - kernel/sched/core.c (SYSCALL_DEFINE0(sched_yield), do_sched_yield)
  - kernel/sched/fair.c (yield_task_fair)
  - kernel/sched/rt.c (yield_task_rt)
  - kernel/sched/deadline.c (yield_task_dl — sets dl_yielded)
  - kernel/sched/idle.c (no yield hook)
  - arch/x86/entry/syscalls/syscall_64.tbl (24 common sched_yield)
-->

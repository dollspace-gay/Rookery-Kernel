# Tier-5 syscall: name_to_handle_at(2) — syscall 303
...
upstream-paths:
  - fs/fhandle.c (SYSCALL_DEFINE5(name_to_handle_at), do_sys_name_to_handle)
  - include/uapi/linux/fcntl.h (AT_*)
  - include/linux/exportfs.h (struct file_handle, encode_fh)
  - arch/x86/entry/syscalls/syscall_64.tbl (303  common  name_to_handle_at)
-->

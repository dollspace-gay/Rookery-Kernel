...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`191  common  getxattr  sys_getxattr`)
  - fs/xattr.c (`SYSCALL_DEFINE4(getxattr, ...)`, `path_getxattr`, `getxattr`, `vfs_getxattr`, `__vfs_getxattr`, `xattr_getsecurity`)
  - fs/namei.c (`user_path_at`, `LOOKUP_FOLLOW`)
  - include/uapi/linux/xattr.h (`XATTR_NAME_MAX`, `XATTR_SIZE_MAX`, namespace prefixes)

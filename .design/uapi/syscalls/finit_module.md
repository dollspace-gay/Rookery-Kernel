# Tier-5 syscall: finit_module(2) — syscall 313
...
upstream-paths:
  - kernel/module/main.c (SYSCALL_DEFINE3(finit_module), idempotent_init_module)
  - kernel/module/decompress.c (xz/gz/zstd decode)
  - kernel/module/signing.c (mod_verify_sig)
  - include/uapi/linux/module.h (MODULE_INIT_*)
  - arch/x86/entry/syscalls/syscall_64.tbl (313  common  finit_module)
-->

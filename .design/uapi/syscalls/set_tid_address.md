# Tier-5 syscall: set_tid_address(2) — syscall 218
...
upstream-paths:
  - kernel/fork.c (SYSCALL_DEFINE1(set_tid_address), task->clear_child_tid)
  - kernel/exit.c (mm_release, futex wake of clear_child_tid)
  - include/linux/sched.h (task_struct::clear_child_tid)
  - arch/x86/entry/syscalls/syscall_64.tbl (218 common set_tid_address)
-->

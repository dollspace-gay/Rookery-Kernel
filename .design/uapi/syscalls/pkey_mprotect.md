# Tier-5: syscall 329 — pkey_mprotect(2)
...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`329  common  pkey_mprotect  sys_pkey_mprotect`)
  - mm/mprotect.c (`SYSCALL_DEFINE4(pkey_mprotect, ...)`, `do_mprotect_pkey`)
  - mm/mmap.c (`mm_pkey_is_allocated`)
  - arch/x86/include/asm/pkeys.h (`PKEY_DISABLE_ACCESS`, `PKEY_DISABLE_WRITE`, `arch_max_pkey`)
  - arch/x86/kernel/pkeys.c (`mm_pkey_alloc`, `mm_pkey_free`, `arch_override_mprotect_pkey`)
  - include/uapi/asm-generic/mman-common.h (`PROT_*`)
-->

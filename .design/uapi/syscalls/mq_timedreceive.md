# Tier-5: syscall 243 — mq_timedreceive(2)
...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`243  common  mq_timedreceive  sys_mq_timedreceive`)
  - ipc/mqueue.c (`SYSCALL_DEFINE5(mq_timedreceive, ...)`, `do_mq_timedreceive`, `pipelined_receive`)

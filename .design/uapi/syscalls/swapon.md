# Tier-5 syscall: swapon(2) — syscall 167
...
upstream-paths:
  - mm/swapfile.c (SYSCALL_DEFINE2(swapon), __do_sys_swapon, claim_swapfile, setup_swap_extents)
  - mm/swapfile.c (read_swap_header, swap_avail_heads, plist_add)
  - include/uapi/linux/swap.h (SWAP_FLAG_PREFER, SWAP_FLAG_PRIO_MASK, SWAP_FLAG_DISCARD, ...)
  - arch/x86/entry/syscalls/syscall_64.tbl (167  common  swapon)
-->

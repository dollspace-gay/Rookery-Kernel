# Tier-5 syscall: times(2) — syscall 100
...
upstream-paths:
  - kernel/sys.c (SYSCALL_DEFINE1(times), do_sys_times)
  - include/uapi/asm-generic/posix_types.h (clock_t)
  - include/uapi/linux/times.h (struct tms)
  - kernel/sched/cputime.c (thread_group_cputime_adjusted)
  - arch/x86/entry/syscalls/syscall_64.tbl (100  common  times)
-->

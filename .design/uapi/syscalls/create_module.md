# Tier-5 syscall: create_module(2) — syscall 174 (DEPRECATED)
...
upstream-paths:
  - kernel/sys_ni.c (COND_SYSCALL(create_module))
  - arch/x86/entry/syscalls/syscall_64.tbl (174  64  create_module)
  - Documentation/admin-guide/sysctl/kernel.rst (modules_disabled)
  - include/uapi/asm-generic/unistd.h (alias absent on generic; x86-only legacy)
-->

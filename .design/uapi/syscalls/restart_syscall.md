# Tier-5 syscall: restart_syscall(2) — syscall 219
...
upstream-paths:
  - kernel/signal.c (sys_restart_syscall, do_no_restart_syscall)
  - arch/x86/entry/common.c (syscall_exit_to_user_mode / signal restart handling)
  - arch/*/kernel/signal.c (handle_signal sets TIF_SIGPENDING → restart-block)
  - include/linux/restart_block.h (struct restart_block)
  - arch/*/include/generated/uapi/asm/unistd_64.h (219)
  - Documentation/admin-guide/restart-syscall.rst, man restart_syscall(2)
-->

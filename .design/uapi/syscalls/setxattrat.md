# Tier-5: syscall 463 — setxattrat(2)
...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`463  common  setxattrat  sys_setxattrat`)
  - fs/xattr.c (`SYSCALL_DEFINE6(setxattrat, ...)`, `do_setxattrat`, `__vfs_setxattr_locked`)
  - fs/namei.c (`user_path_at`, `do_path_lookupat`)
  - include/uapi/linux/xattr.h (`struct xattr_args`, `XATTR_CREATE`, `XATTR_REPLACE`)

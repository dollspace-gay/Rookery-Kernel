# Tier-5 syscall: semtimedop(2) — syscall 220
...
upstream-paths:
  - ipc/sem.c (SYSCALL_DEFINE4(semtimedop), do_semtimedop)
  - include/uapi/linux/sem.h (struct sembuf)
  - include/uapi/linux/time.h (struct timespec, struct __kernel_timespec)
  - arch/x86/entry/syscalls/syscall_64.tbl (220 common semtimedop)
-->

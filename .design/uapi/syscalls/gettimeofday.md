# Tier-5 syscall: gettimeofday(2) — syscall 96
...
upstream-paths:
  - kernel/time/time.c (sys_gettimeofday, do_gettimeofday)
  - kernel/time/timekeeping.c (ktime_get_real_ts64)
  - arch/x86/entry/vdso/vclock_gettime.c (__vdso_gettimeofday)
  - kernel/time/vsyscall.c (update_vsyscall — vDSO data)
  - include/uapi/linux/time.h (struct timeval, struct timezone)
  - arch/*/include/generated/uapi/asm/unistd_64.h (96)
  - Documentation/core-api/timekeeping.rst, man gettimeofday(2)
-->

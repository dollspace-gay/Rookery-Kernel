# Tier-5 syscall: epoll_create(2) — syscall 213
...
upstream-paths:
  - fs/eventpoll.c (SYSCALL_DEFINE1(epoll_create))
  - fs/eventpoll.c (SYSCALL_DEFINE1(epoll_create1))
  - fs/eventpoll.c (ep_alloc, struct eventpoll)
  - include/uapi/linux/eventpoll.h
  - arch/x86/entry/syscalls/syscall_64.tbl (213 common epoll_create)
-->

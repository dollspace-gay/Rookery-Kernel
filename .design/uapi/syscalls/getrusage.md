# Tier-5 syscall: getrusage(2) — syscall 98
...
upstream-paths:
  - kernel/sys.c (SYSCALL_DEFINE2(getrusage), getrusage, do_sys_times-equivalent)
  - kernel/sched/cputime.c (task_cputime_adjusted, thread_group_cputime_adjusted)
  - include/uapi/linux/resource.h (struct rusage, RUSAGE_*)
  - include/linux/sched.h (task_struct.signal->cutime, cstime, ...)
  - arch/x86/entry/syscalls/syscall_64.tbl (98  common  getrusage)
-->

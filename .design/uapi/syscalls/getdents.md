# Tier-5 syscall: getdents(2) — syscall 78
...
upstream-paths:
  - fs/readdir.c (SYSCALL_DEFINE3(getdents), filldir, iterate_dir)
  - include/linux/dirent.h (struct linux_dirent)
  - include/linux/fs.h (struct dir_context, iterate_shared)
  - arch/x86/entry/syscalls/syscall_64.tbl (78  common  getdents)
-->

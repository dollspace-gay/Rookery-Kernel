# Tier-5 syscall: utime(2) — syscall 132
...
upstream-paths:
  - fs/utimes.c (SYSCALL_DEFINE2(utime, ...), do_utimes, vfs_utimes)
  - include/uapi/linux/utime.h (struct utimbuf)
  - include/linux/fs.h (struct iattr, ATTR_ATIME, ATTR_MTIME, ATTR_TOUCH)
  - arch/x86/entry/syscalls/syscall_64.tbl (132  64  utime)
-->

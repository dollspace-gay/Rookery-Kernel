# Tier-5 syscall: get_kernel_syms(2) — syscall 177 (DEPRECATED)
...
upstream-paths:
  - kernel/sys_ni.c (COND_SYSCALL(get_kernel_syms))
  - arch/x86/entry/syscalls/syscall_64.tbl (177  64  get_kernel_syms)
  - Documentation/ABI/removed/get_kernel_syms (historical)
  - /proc/kallsyms (modern replacement for kernel-symbol discovery)
-->

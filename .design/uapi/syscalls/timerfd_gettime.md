# Tier-5 syscall: timerfd_gettime(2) — syscall 287
...
upstream-paths:
  - fs/timerfd.c (sys_timerfd_gettime, do_timerfd_gettime)
  - kernel/time/hrtimer.c (hrtimer_get_remaining)
  - kernel/time/alarmtimer.c (alarm_get_remaining)
  - arch/*/include/generated/uapi/asm/unistd_64.h (287)
  - Documentation/admin-guide/timerfd.rst, man timerfd_gettime(2)
-->

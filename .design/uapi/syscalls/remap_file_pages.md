# Tier-5 syscall: remap_file_pages(2) — syscall 216
...
upstream-paths:
  - mm/mmap.c (SYSCALL_DEFINE5(remap_file_pages))
  - mm/nonlinear.c (deleted upstream; emulated via mmap)
  - include/linux/mman.h (deprecated path)
  - arch/x86/entry/syscalls/syscall_64.tbl (216  common  remap_file_pages)
-->

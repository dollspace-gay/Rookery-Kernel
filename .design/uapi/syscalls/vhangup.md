# Tier-5 syscall: vhangup(2) — syscall 153
...
upstream-paths:
  - drivers/tty/tty_io.c (SYSCALL_DEFINE0(vhangup), tty_vhangup, __do_SAK)
  - drivers/tty/tty_jobctrl.c (signal delivery to session)
  - drivers/tty/tty_ldisc.c (line-discipline tear-down)
  - kernel/capability.c (capable(CAP_SYS_TTY_CONFIG))
  - arch/x86/entry/syscalls/syscall_64.tbl (153 common vhangup)
  - man vhangup(2)
-->

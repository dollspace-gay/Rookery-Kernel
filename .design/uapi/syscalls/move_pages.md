# Tier-5 syscall: move_pages(2) — syscall 279
...
upstream-paths:
  - mm/migrate.c (SYSCALL_DEFINE6(move_pages), kernel_move_pages, do_move_pages)
  - mm/migrate.c (add_page_for_migration, move_pages_and_store_status, do_pages_stat)
  - include/uapi/linux/mempolicy.h (MPOL_MF_MOVE, MPOL_MF_MOVE_ALL)
  - arch/x86/entry/syscalls/syscall_64.tbl (279  common  move_pages)
-->

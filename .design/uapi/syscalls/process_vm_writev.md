# Tier-5 syscall: process_vm_writev(2) — syscall 311
...
upstream-paths:
  - mm/process_vm_access.c (SYSCALL_DEFINE6(process_vm_writev), process_vm_rw, process_vm_rw_core)
  - kernel/ptrace.c (__ptrace_may_access, ptrace_may_access)
  - include/uapi/linux/uio.h (struct iovec)
  - arch/x86/entry/syscalls/syscall_64.tbl (311  common  process_vm_writev)
-->

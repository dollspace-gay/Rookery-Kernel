# Tier-5 syscall: clock_nanosleep(2) — syscall 230
...
upstream-paths:
  - kernel/time/posix-timers.c (sys_clock_nanosleep, common_nsleep)
  - kernel/time/hrtimer.c (hrtimer_nanosleep, do_nanosleep)
  - kernel/time/posix-cpu-timers.c (posix_cpu_nsleep)
  - kernel/time/alarmtimer.c (alarm_timer_nsleep)
  - include/uapi/linux/time.h (clockid_t, TIMER_ABSTIME, __kernel_timespec)
  - arch/*/include/generated/uapi/asm/unistd_64.h (230)
  - Documentation/core-api/timekeeping.rst, man clock_nanosleep(2)
-->

# Tier-5 syscall: process_madvise(2) — syscall 440
...
upstream-paths:
  - mm/madvise.c (SYSCALL_DEFINE5(process_madvise))
  - mm/madvise.c (do_madvise, madvise_walk_vmas)
  - kernel/pid.c (pidfd_get_pid)
  - fs/read_write.c (import_iovec)
  - include/uapi/asm-generic/mman-common.h (MADV_*)
  - arch/x86/entry/syscalls/syscall_64.tbl (440 common process_madvise)
-->

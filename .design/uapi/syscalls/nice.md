# Tier-5 syscall: nice(2) — syscall 34
...
upstream-paths:
  - kernel/sched/syscalls.c (SYSCALL_DEFINE1(nice))
  - kernel/sched/core.c (set_user_nice, increment_to_nice wrapper)
  - include/uapi/asm-generic/unistd.h (nice deprecated on arm64 generic)
  - arch/x86/entry/syscalls/syscall_64.tbl (34 common nice)
-->

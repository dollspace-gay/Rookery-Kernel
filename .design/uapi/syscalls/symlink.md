...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`88  common  symlink  sys_symlink`)
  - fs/namei.c (`SYSCALL_DEFINE2(symlink, ...)`, `do_symlinkat`, `vfs_symlink`)

# Tier-5 syscall: munlock(2) — syscall 150
...
upstream-paths:
  - mm/mlock.c (SYSCALL_DEFINE2(munlock), apply_vma_lock_flags, mlock_fixup)
  - mm/internal.h (munlock_vma_folio, mlock_drain_local)
  - include/linux/mman.h (VM_LOCKED)
  - arch/x86/entry/syscalls/syscall_64.tbl (150  common  munlock)
-->

# Tier-5 syscall: pidfd_open(2) — syscall 434
...
upstream-paths:
  ...
  - kernel/pid.c (pidfd_create, pidfd_get_pid)
  - fs/anon_inodes.c (anon_inode_getfile)
  - include/uapi/linux/pidfd.h (PIDFD_NONBLOCK, PIDFD_THREAD, PIDFD_SELF)
  - arch/x86/entry/syscalls/syscall_64.tbl (434 common pidfd_open)
-->

# Tier-5 syscall: execve(2) — syscall 59
...
upstream-paths:
  - fs/exec.c (sys_execve, do_execveat_common, bprm_execve)
  - include/linux/binfmts.h (struct linux_binprm)
  - include/uapi/linux/binfmts.h (MAX_ARG_STRLEN, MAX_ARG_STRINGS, BINPRM_BUF_SIZE)
  - arch/x86/entry/syscalls/syscall_64.tbl (59  common  execve)
-->

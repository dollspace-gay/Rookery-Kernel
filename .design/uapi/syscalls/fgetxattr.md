# Tier-5: syscall 193 — fgetxattr(2)
...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`193  common  fgetxattr  sys_fgetxattr`)
  - fs/xattr.c (`SYSCALL_DEFINE4(fgetxattr, ...)`, `getxattr`, `vfs_getxattr`)

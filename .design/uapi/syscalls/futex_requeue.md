# Tier-5 syscall: futex_requeue(2) — syscall 456
...
upstream-paths:
  - kernel/futex/syscalls.c (SYSCALL_DEFINE4(futex_requeue), futex2_to_flags)
  - kernel/futex/requeue.c (futex_requeue, requeue_pi_wake_futex)
  - kernel/futex/core.c (futex_hash, get_futex_key, futex_q)
  - include/uapi/linux/futex.h (struct futex_waitv, FUTEX2_*)
  - arch/x86/entry/syscalls/syscall_64.tbl (456  common  futex_requeue)
-->

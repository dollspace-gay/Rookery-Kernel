# Tier-5 syscall: set_mempolicy_home_node(2) — syscall 450
...
upstream-paths:
  - mm/mempolicy.c (SYSCALL_DEFINE4(set_mempolicy_home_node), do_set_mempolicy_home_node)
  - mm/mempolicy.c (mpol_set_home_node)
  - include/uapi/linux/mempolicy.h (MPOL_PREFERRED_MANY, MPOL_BIND, MPOL_INTERLEAVE, MPOL_WEIGHTED_INTERLEAVE)
  - arch/x86/entry/syscalls/syscall_64.tbl (450  common  set_mempolicy_home_node)
-->

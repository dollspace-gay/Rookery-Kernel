# Tier-5 syscall: semctl(2) — syscall 66
...
upstream-paths:
  - ipc/sem.c (SYSCALL_DEFINE4(semctl), semctl_main, semctl_setval, semctl_info, semctl_stat, freeary)
  - ipc/util.c (ipc_rmid)
  - include/uapi/linux/sem.h (struct semid_ds, struct seminfo, GETVAL, GETPID, GETNCNT, GETZCNT, GETALL, SETVAL, SETALL, SEM_INFO, SEM_STAT, SEM_STAT_ANY)
  - include/uapi/linux/ipc.h (IPC_STAT, IPC_SET, IPC_RMID, IPC_INFO)
  - arch/x86/entry/syscalls/syscall_64.tbl (66  common  semctl)
-->

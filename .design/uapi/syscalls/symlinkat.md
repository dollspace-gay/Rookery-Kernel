# Tier-5: syscall 266 — symlinkat(2)
...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`266  common  symlinkat  sys_symlinkat`)
  - fs/namei.c (`SYSCALL_DEFINE3(symlinkat, ...)`, `do_symlinkat`, `vfs_symlink`, `may_create`)
  - include/uapi/linux/fcntl.h (`AT_FDCWD`)

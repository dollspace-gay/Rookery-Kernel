# Tier-5 syscall: rt_sigreturn(2) — syscall 15
...
upstream-paths:
  - arch/x86/kernel/signal.c (SYSCALL_DEFINE0(rt_sigreturn), restore_sigcontext)
  - arch/x86/kernel/signal_64.c (per-arch signal frame layout)
  - kernel/signal.c (do_signal_stop, sigframe handling)
  - include/uapi/asm-generic/signal.h (struct sigcontext, struct ucontext)

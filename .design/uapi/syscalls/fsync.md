# Tier-5 syscall: fsync(2) — syscall 74
...
upstream-paths:
  - fs/sync.c (SYSCALL_DEFINE1(fsync), do_fsync, vfs_fsync, vfs_fsync_range)
  - include/linux/fs.h (file_operations::fsync)
  - arch/x86/entry/syscalls/syscall_64.tbl (74  common  fsync)
-->

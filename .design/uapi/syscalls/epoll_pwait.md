# Tier-5 syscall: epoll_pwait(2) — syscall 281
...
upstream-paths:
  - fs/eventpoll.c (SYSCALL_DEFINE6(epoll_pwait))
  - fs/eventpoll.c (do_epoll_wait, ep_poll)
  - kernel/signal.c (set_user_sigmask, restore_saved_sigmask)
  - include/uapi/linux/eventpoll.h
  - arch/x86/entry/syscalls/syscall_64.tbl (281 64 epoll_pwait)
-->

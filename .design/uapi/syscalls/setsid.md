# Tier-5 syscall: setsid(2) — syscall 112
...
upstream-paths:
  - kernel/sys.c (SYSCALL_DEFINE0(setsid), ksys_setsid)
  - kernel/pid.c (alloc_pid, attach_pid, change_pid)
  - include/linux/sched/signal.h (task_session, PIDTYPE_SID)
  - drivers/tty/tty_jobctrl.c (disassociate_ctty)
  - arch/x86/entry/syscalls/syscall_64.tbl (112  common  setsid)
-->

# Tier-5 syscall: setgid(2) — syscall 106
...
upstream-paths:
  - kernel/sys.c (SYSCALL_DEFINE1(setgid, gid_t))
  - kernel/cred.c (prepare_creds, commit_creds, abort_creds)
  - security/commoncap.c (cap_task_fix_setuid for SETID flag — actually applied only for setuid family)
  - include/linux/cred.h (struct cred)
  - include/linux/securebits.h
  - arch/x86/entry/syscalls/syscall_64.tbl (106  common  setgid)
-->

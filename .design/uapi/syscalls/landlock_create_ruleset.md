# Tier-5 syscall: landlock_create_ruleset(2) — syscall 444
...
upstream-paths:
  - security/landlock/syscalls.c (SYSCALL_DEFINE3(landlock_create_ruleset), get_ruleset_from_fd)
  - security/landlock/ruleset.c (landlock_create_ruleset, landlock_put_ruleset)
  - security/landlock/fs.c (FS access rights)
  - security/landlock/net.c (Net access rights, 6.7+)
  - include/uapi/linux/landlock.h (struct landlock_ruleset_attr, LANDLOCK_ACCESS_FS_*, LANDLOCK_ACCESS_NET_*, LANDLOCK_CREATE_RULESET_VERSION)
  - arch/x86/entry/syscalls/syscall_64.tbl (444  common  landlock_create_ruleset)
  - Documentation/userspace-api/landlock.rst, man landlock(7), landlock_create_ruleset(2)
-->

# Tier-5 syscall: getrandom(2) — syscall 318
...
upstream-paths:
  - drivers/char/random.c (SYSCALL_DEFINE3(getrandom), get_random_bytes_user)
  - include/uapi/linux/random.h (GRND_NONBLOCK, GRND_RANDOM, GRND_INSECURE)
  - arch/x86/entry/syscalls/syscall_64.tbl (318  common  getrandom)
-->

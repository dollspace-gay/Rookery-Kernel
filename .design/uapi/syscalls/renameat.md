# Tier-5 syscall: renameat(2) — syscall 264
...
upstream-paths:
  - fs/namei.c (SYSCALL_DEFINE4(renameat), do_renameat2, vfs_rename, lock_rename, inode_operations::rename)
  - include/uapi/linux/fs.h (RENAME_NOREPLACE, RENAME_EXCHANGE, RENAME_WHITEOUT)
  - arch/x86/entry/syscalls/syscall_64.tbl (264  common  renameat)
-->

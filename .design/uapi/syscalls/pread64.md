# Tier-5 syscall: pread64(2) — syscall 17
...
upstream-paths:
  - fs/read_write.c (SYSCALL_DEFINE4(pread64), do_pread, vfs_pread)
  - include/linux/fs.h (struct file, f_op->read_iter)
  - arch/x86/entry/syscalls/syscall_64.tbl (17  common  pread64)
-->

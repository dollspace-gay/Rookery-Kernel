# Tier-5 special entry: uretprobe — userspace-probe return-trampoline
...
upstream-paths:
  - kernel/events/uprobes.c (uretprobe_trampoline, handle_trampoline, prepare_uretprobe)
  - arch/x86/kernel/uprobes.c (arch_uretprobe_hijack_return_addr, ARCH_UPROBE_RET_TRAMPOLINE)
  - arch/x86/entry/syscalls/syscall_64.tbl (335  common  uretprobe — x86_64-only fast-path syscall in some kernels)
  - include/linux/uprobes.h (struct return_instance)
  - kernel/trace/trace_uprobe.c (ret_handler attachment)
-->

# Tier-5 syscall: landlock_add_rule(2) — syscall 445
...
upstream-paths:
  - security/landlock/syscalls.c (SYSCALL_DEFINE4(landlock_add_rule), add_rule_path_beneath, add_rule_net_port)
  - security/landlock/ruleset.c (landlock_append_rule, landlock_insert_rule)
  - security/landlock/fs.c (path-beneath rule, hierarchy_layers, path_walk)
  - security/landlock/net.c (net-port rule, port bind/connect filtering)
  - include/uapi/linux/landlock.h (enum landlock_rule_type, struct landlock_path_beneath_attr, struct landlock_net_port_attr)
  - arch/x86/entry/syscalls/syscall_64.tbl (445  common  landlock_add_rule)
-->

# Tier-5 syscall: epoll_wait(2) — syscall 232
...
upstream-paths:
  - fs/eventpoll.c (SYSCALL_DEFINE4(epoll_wait))
  - fs/eventpoll.c (do_epoll_wait, ep_poll)
  - fs/eventpoll.c (ep_send_events, ep_scan_ready_list)
  - include/uapi/linux/eventpoll.h
  - arch/x86/entry/syscalls/syscall_64.tbl (232 common epoll_wait)
-->

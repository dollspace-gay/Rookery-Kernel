# Tier-5 syscall: time(2) — syscall 201
...
upstream-paths:
  - kernel/time/time.c (SYSCALL_DEFINE1(time))
  - kernel/time/timekeeping.c (ktime_get_real_seconds)
  - include/uapi/asm-generic/posix_types.h (time_t == __kernel_time_t)
  - arch/x86/entry/syscalls/syscall_64.tbl (201 common time)
  - man time(2)
-->

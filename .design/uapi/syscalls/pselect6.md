# Tier-5 syscall: pselect6(2) — syscall 270
...
upstream-paths:
  - fs/select.c (SYSCALL_DEFINE6(pselect6), do_pselect, core_sys_select, do_select)
  - kernel/signal.c (set_user_sigmask, restore_saved_sigmask)
  - include/linux/poll.h (struct fdtable, fd_set)
  - include/uapi/linux/posix_types.h (fd_set, FD_SETSIZE = 1024)
  - arch/x86/entry/syscalls/syscall_64.tbl (270  64  pselect6)
-->

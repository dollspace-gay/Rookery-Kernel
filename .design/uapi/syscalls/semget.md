# Tier-5 syscall: semget(2) — syscall 64
...
upstream-paths:
  - ipc/sem.c (SYSCALL_DEFINE3(semget), newary, sem_more_checks)
  - ipc/util.c (ipcget, ipc_addid)
  - include/uapi/linux/sem.h (struct semid_ds, struct sembuf, SEMVMX, SEMMSL, SEMMNS, SEMOPM, SEMMNI)
  - include/uapi/linux/ipc.h (IPC_PRIVATE, IPC_CREAT, IPC_EXCL)
  - arch/x86/entry/syscalls/syscall_64.tbl (64  common  semget)
-->

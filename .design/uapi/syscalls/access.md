# Tier-5 syscall: access(2) — syscall 21
...
upstream-paths:
  - fs/open.c (SYSCALL_DEFINE2(access), do_faccessat)
  - fs/namei.c (path_lookupat, may_open)
  - include/uapi/linux/fcntl.h (R_OK, W_OK, X_OK, F_OK)
  - arch/x86/entry/syscalls/syscall_64.tbl (21 common access)
  - man access(2), faccessat(2)
-->

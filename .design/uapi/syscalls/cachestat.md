# Tier-5 syscall: cachestat(2) — syscall 451
...
upstream-paths:
  - mm/filemap.c (SYSCALL_DEFINE4(cachestat), cachestat_fill, cachestat_filemap)
  - include/uapi/linux/mman.h (struct cachestat, struct cachestat_range)
  - mm/shmem.c (shmem_cachestat)
  - arch/x86/entry/syscalls/syscall_64.tbl (451  common  cachestat)
-->

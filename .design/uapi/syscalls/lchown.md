# Tier-5 syscall: lchown(2) — syscall 94
...
upstream-paths:
  - fs/open.c (SYSCALL_DEFINE3(lchown), chown_common, do_fchownat)
  - fs/namei.c (user_path_at, LOOKUP_FOLLOW=0)
  - fs/attr.c (notify_change)
  - include/linux/fs.h (struct iattr)
  - arch/x86/entry/syscalls/syscall_64.tbl (94  common  lchown)
-->

# Tier-5: syscall 466 — removexattrat(2)
...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`466  common  removexattrat  sys_removexattrat`)
  - fs/xattr.c (`SYSCALL_DEFINE4(removexattrat, ...)`, `do_removexattrat`, `__vfs_removexattr_locked`)

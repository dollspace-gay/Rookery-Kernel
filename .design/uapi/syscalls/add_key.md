# Tier-5 syscall: add_key(2) — syscall 248
...
upstream-paths:
  - security/keys/keyctl.c (SYSCALL_DEFINE5(add_key))
  - security/keys/key.c (key_alloc, key_instantiate_and_link, __key_link)
  - security/keys/keyring.c (keyring_search, __key_create_or_update)
  - include/uapi/linux/keyctl.h (KEY_SPEC_*)
  - include/linux/key.h (struct key, key_type, key_serial_t)
  - arch/x86/entry/syscalls/syscall_64.tbl (248  common  add_key)
  - Documentation/security/keys/core.rst, man add_key(2), keyrings(7), keyutils(7)
-->

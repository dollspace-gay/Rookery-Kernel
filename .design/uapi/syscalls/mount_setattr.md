# Tier-5: syscall 442 — mount_setattr(2)
...
upstream-paths:
  - fs/namespace.c (do_mount_setattr, build_mount_kattr, mount_setattr_prepare, mount_setattr_commit)
  - include/uapi/linux/mount.h (struct mount_attr, MOUNT_ATTR_*)

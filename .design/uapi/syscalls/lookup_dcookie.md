# Tier-5 syscall: lookup_dcookie(2) — syscall 212

<!--
baseline-commit: 27a26ccfd528da725a999ea1e3102503c61eb655
baseline-version: 7.1.0-rc2
status: draft   (DEPRECATED — removed upstream in 6.7)
parent: uapi/00-overview.md
upstream-paths:
  - fs/dcookies.c  (SYSCALL_DEFINE3(lookup_dcookie), get_dcookie, dcookie_*)
  - include/linux/dcookies.h (struct dcookie, dcookie_register, dcookie_unregister)
  - arch/x86/entry/syscalls/syscall_64.tbl (212  64  lookup_dcookie)
-->
...
- Should Rookery follow upstream and remove the syscall slot entirely (vs ENOSYS stub)? Argument FOR removal: smaller ABI surface, no attack-surface ambiguity. Argument AGAINST: forensic / archaeological tools (`strace -e lookup_dcookie`) on old kernel-traces still need the slot known. Current Rookery decision: keep slot, return ENOSYS — matches the 6.7+ upstream "removed but slot reserved" pattern.

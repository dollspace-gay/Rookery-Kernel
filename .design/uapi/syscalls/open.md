...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`2  common  open  sys_open`)
  - fs/open.c (`SYSCALL_DEFINE3(open, ...)`, `do_sys_open`, `do_sys_openat2`, `build_open_how`, `build_open_flags`, `do_file_open`, `force_o_largefile`)
  - fs/namei.c (`path_openat`, `do_filp_open`, `vfs_open`, `may_open`)
  - include/linux/fcntl.h (`VALID_OPEN_FLAGS`)
  - include/uapi/asm-generic/fcntl.h (`O_RDONLY` .. `O_TMPFILE`)
-->

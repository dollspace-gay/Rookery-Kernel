...
upstream-paths:
  - arch/x86/entry/syscalls/syscall_64.tbl (`265  common  linkat  sys_linkat`)
  - fs/namei.c (`SYSCALL_DEFINE5(linkat, ...)`, `do_linkat`, `vfs_link`, `may_linkat`)
  - include/uapi/linux/fcntl.h (`AT_FDCWD`, `AT_EMPTY_PATH`, `AT_SYMLINK_FOLLOW`)
-->

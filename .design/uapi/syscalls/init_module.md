# Tier-5 syscall: init_module(2) — syscall 175
...
upstream-paths:
  - kernel/module/main.c (SYSCALL_DEFINE3(init_module), load_module, copy_module_from_user)
  - kernel/module/signing.c (mod_verify_sig)
  - include/linux/moduleloader.h
  - arch/x86/entry/syscalls/syscall_64.tbl (175  common  init_module)
-->

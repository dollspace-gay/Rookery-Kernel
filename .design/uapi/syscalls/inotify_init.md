# Tier-5 syscall: inotify_init(2) — syscall 253
...
upstream-paths:
  - fs/notify/inotify/inotify_user.c (SYSCALL_DEFINE0(inotify_init), do_inotify_init)
  - fs/notify/inotify/inotify_fsnotify.c
  - include/uapi/linux/inotify.h
  - arch/x86/entry/syscalls/syscall_64.tbl (253 common inotify_init)
  - man inotify_init(2), inotify(7)
-->

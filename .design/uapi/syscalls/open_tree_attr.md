# Tier-5 syscall: open_tree_attr(2) — forward-looking (ENOSYS in 7.1.0-rc2)
...
upstream-paths:
  - fs/namespace.c (existing SYSCALL_DEFINE3(open_tree, ...), proposed SYSCALL_DEFINE5(open_tree_attr, ...))
  - fs/namespace.c (struct mount_attr, mount_setattr)
  - include/uapi/linux/mount.h (OPEN_TREE_CLONE, OPEN_TREE_CLOEXEC, AT_RECURSIVE)
  - include/uapi/linux/mount.h (struct mount_attr, MOUNT_ATTR_*, MOUNT_ATTR_IDMAP)
  - arch/x86/entry/syscalls/syscall_64.tbl (471  common  open_tree_attr  (reserved, not wired))
-->

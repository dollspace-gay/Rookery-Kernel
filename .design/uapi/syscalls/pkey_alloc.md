# Tier-5 syscall: pkey_alloc(2) — syscall 330
...
upstream-paths:
  - mm/mprotect.c (SYSCALL_DEFINE2(pkey_alloc), do_pkey_alloc)
  - arch/x86/mm/pkeys.c (mm_pkey_alloc, init_pkru_value, __arch_set_user_pkey_access)
  - include/uapi/asm-generic/mman-common.h (PKEY_DISABLE_ACCESS, PKEY_DISABLE_WRITE)
  - include/linux/pkeys.h (struct mm_pkey_alloc_state)
  - arch/x86/entry/syscalls/syscall_64.tbl (330  common  pkey_alloc)
-->

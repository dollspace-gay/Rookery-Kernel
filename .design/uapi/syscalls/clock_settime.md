# Tier-5 syscall: clock_settime(2) — syscall 227
...
upstream-paths:
  - kernel/time/posix-timers.c (sys_clock_settime, do_clock_settime)
  - kernel/time/timekeeping.c (do_settimeofday64, timekeeping_inject_offset)
  - kernel/time/ntp.c (ntp_clear, ntp_update_frequency)
  - include/uapi/linux/time.h (clockid_t, __kernel_timespec)
  - arch/*/include/generated/uapi/asm/unistd_64.h (227)
  - Documentation/core-api/timekeeping.rst, man clock_settime(2)
-->

# Tier-5 syscall: fchmod(2) — syscall 91
...
upstream-paths:
  - fs/open.c (SYSCALL_DEFINE2(fchmod), chmod_common via fd)
  - fs/attr.c (notify_change)
  - include/linux/fs.h (struct file, struct iattr, ATTR_MODE)
  - arch/x86/entry/syscalls/syscall_64.tbl (91  common  fchmod)
-->

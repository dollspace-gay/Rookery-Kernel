# Tier-5 syscall: iopl(2) — syscall 172
...
upstream-paths:
  - arch/x86/kernel/ioport.c (ksys_iopl)
  - arch/x86/include/asm/processor.h (struct thread_struct.iopl)
  - arch/x86/entry/syscalls/syscall_64.tbl (172  common  iopl)
  - arch/x86/entry/syscalls/syscall_32.tbl (110  i386    iopl)
-->

...
upstream-paths:
  - fs/namespace.c (path_umount, do_umount, can_umount, umount_tree)
  - include/uapi/linux/fs.h (MNT_FORCE, MNT_DETACH, MNT_EXPIRE, UMOUNT_NOFOLLOW)
-->

# Tier-5 syscall: sched_getscheduler(2) — syscall 145
...
upstream-paths:
  ...
  - kernel/sched/syscalls.c (_sched_getscheduler helper)
  - include/uapi/linux/sched.h (SCHED_* constants)
  - arch/x86/entry/syscalls/syscall_64.tbl (145 common sched_getscheduler)
-->

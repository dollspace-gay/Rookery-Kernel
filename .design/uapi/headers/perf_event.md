# Tier-5 UAPI: include/uapi/linux/perf_event.h — perf_event_open(2) ABI
...
upstream-paths:
  - include/uapi/linux/perf_event.h (~1528 lines)
  - include/linux/perf_event.h (kernel-internal complement)
  - kernel/events/core.c (perf_event_open + syscall plumbing)
  - kernel/events/ring_buffer.c (mmap'd ring buffer + AUX)
  - include/uapi/linux/hw_breakpoint.h (HW_BREAKPOINT_* used by PERF_TYPE_BREAKPOINT)
  - include/uapi/linux/bpf_perf_event.h (struct bpf_perf_event_data)
  - tools/lib/perf/include/perf/event.h (userspace mirror of records)

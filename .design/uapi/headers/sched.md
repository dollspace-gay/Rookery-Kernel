# Tier-5 UAPI: include/uapi/linux/sched.h — Scheduler + clone(2) ABI
...
upstream-paths:
  - include/uapi/linux/sched.h (~162 lines)
  - include/uapi/linux/sched/types.h (~122 lines, struct sched_attr)
-->
...
(none at this Tier-5 level — `kernel/fork.c`, `kernel/sched/core.c`, `kernel/sched/{fair,rt,deadline,ext}.c`, `kernel/nsproxy.c` Tier-3 docs cover per-implementation internals)

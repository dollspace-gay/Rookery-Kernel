# Tier-5 UAPI: include/uapi/linux/mman.h + include/uapi/asm-generic/mman{,-common}.h — Memory-management ABI
...
upstream-paths:
  - include/uapi/linux/mman.h (~59 lines)
  - include/uapi/asm-generic/mman-common.h (~94 lines)
  - include/uapi/asm-generic/mman.h (~26 lines)
...
(none at this Tier-5 level — `mm/mmap.c`, `mm/mremap.c`, `mm/madvise.c` Tier-3 docs cover per-syscall internals)

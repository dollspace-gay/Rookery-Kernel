# Tier-5 UAPI: include/uapi/linux/futex.h — Futex ABI
...
upstream-paths:
  - include/uapi/linux/futex.h (~212 lines)
-->
...
(none at this Tier-5 level — `kernel/futex/{core,pi,requeue,waitwake,syscalls}.c` Tier-3 docs cover per-implementation internals)

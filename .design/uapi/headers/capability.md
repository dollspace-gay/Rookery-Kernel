# Tier-5 UAPI: include/uapi/linux/capability.h — POSIX capabilities ABI
...
upstream-paths:
  - include/uapi/linux/capability.h (~435 lines)
  - include/linux/capability.h (kernel-internal complement)
  - kernel/capability.c (capget/capset implementations)
  - security/commoncap.c (cap_capable, file-caps lookup)
  - fs/xattr.c (security.capability xattr backing)
  - include/uapi/linux/xattr.h (XATTR_NAME_CAPS)

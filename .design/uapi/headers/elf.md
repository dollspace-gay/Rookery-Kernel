# Tier-5 UAPI: include/uapi/linux/elf.h — ELF binary format ABI
...
upstream-paths:
  - include/uapi/linux/elf.h (~615 lines)
  - include/uapi/linux/elf-em.h (~70 lines, EM_* machine codes)
  - include/uapi/linux/auxvec.h (~44 lines, AT_* auxiliary vector)
-->
...
(none at this Tier-5 level — `fs/binfmt_elf.c`, `fs/coredump.c`, `kernel/module/main.c` Tier-3 docs cover per-implementation internals)

# Tier-5 UAPI: include/uapi/linux/socket.h + include/linux/socket.h — Socket ABI
...
upstream-paths:
  - include/uapi/linux/socket.h (~38 lines)
  - include/linux/socket.h (~480 lines)
  - include/linux/net.h (SOCK_* enum)
-->
...
(none at this Tier-5 level — protocol-family Tier-3 docs cover per-AF specifics)

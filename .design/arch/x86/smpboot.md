# Tier-3: arch/x86/kernel/smpboot.c — x86 SMP secondary-CPU bringup
...
upstream-paths:
  - arch/x86/kernel/smpboot.c (~1511 lines)
  - arch/x86/include/asm/smp.h
  - arch/x86/include/asm/realmode.h (real_mode_header, trampoline_start)
  - arch/x86/realmode/rm/trampoline_64.S (TR_BIOS / trampoline entry)
  - arch/x86/kernel/head_64.S (secondary_startup_64 — AP head)
  - arch/x86/kernel/apic/apic.c (apic_icr_write, lapic_get_maxlvt)
  - include/linux/cpuhotplug.h (CPUHP_AP_ONLINE_IDLE)
-->
...
- Treatment of `apic->wakeup_secondary_cpu_64` for SEV-SNP / TDX in Rookery — implement now or stub to via_init only?
- mwait_play_dead vs hlt_play_dead policy selection: keep upstream's preference order (MWAIT > HLT) verbatim, or restrict to HLT until MWAIT-cacheline-poll is Kani-verified?

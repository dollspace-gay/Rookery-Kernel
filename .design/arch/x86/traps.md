# Tier-3: arch/x86/kernel/traps.c — x86 hardware traps and exception handlers
...
upstream-paths:
  - arch/x86/kernel/traps.c (~1698 lines)
  - arch/x86/include/asm/traps.h (trap-vector defines, IST indices, prototypes)
  - arch/x86/include/asm/idtentry.h (DEFINE_IDTENTRY[_ERRORCODE|_DF|_DEBUG|_DEBUG_USER|_RAW|_SW] / DEFINE_FREDENTRY_DEBUG)
  - arch/x86/include/asm/irq_stack.h (IST stack switch helpers)
  - arch/x86/kernel/idt.c (idt_setup_traps())
  - arch/x86/kernel/cet.c (exc_control_protection — #CP)
  - arch/x86/kernel/cpu/mce/core.c (exc_machine_check — #MC)
  - arch/x86/kernel/nmi.c (exc_nmi)
  - arch/x86/kernel/sev.c (exc_vmm_communication — #VC)
  - arch/x86/mm/fault.c (exc_page_fault — #PF, covered in its own Tier-3)
  - arch/x86/kernel/cpu/bugs.c (split-lock handler hook)
-->

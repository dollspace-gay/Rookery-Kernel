# Tier-3: arch/x86/kernel/cpu/common.c — x86 per-CPU identification and init
...
upstream-paths:
  - arch/x86/kernel/cpu/common.c (~2670 lines)
  - arch/x86/include/asm/processor.h (struct cpuinfo_x86, struct cpu_dev)
  - arch/x86/include/asm/cpufeatures.h (X86_FEATURE_*)
  - arch/x86/include/asm/desc.h, arch/x86/include/asm/tss.h
-->

# Tier-3: arch/x86/kernel/cpu/intel.c — Intel CPU init, errata and feature gating
...
upstream-paths:
  - arch/x86/kernel/cpu/intel.c (~786 lines)
  - arch/x86/include/asm/intel-family.h
  - arch/x86/include/asm/msr-index.h (MSR_IA32_MISC_ENABLE, MSR_MISC_FEATURES_ENABLES, MSR_PLATFORM_INFO, MSR_IA32_TME_ACTIVATE)
  - arch/x86/include/asm/cpufeatures.h (X86_FEATURE_*, X86_BUG_*)
-->

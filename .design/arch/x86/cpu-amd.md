# Tier-3: arch/x86/kernel/cpu/amd.c — AMD CPU init, errata and feature gating
...
upstream-paths:
  - arch/x86/kernel/cpu/amd.c (~1434 lines)
  - arch/x86/include/asm/msr-index.h (MSR_K6_WHCR, MSR_K7_HWCR, MSR_K7_CLK_CTL, MSR_AMD64_*, MSR_F15H_IC_CFG, MSR_F16H_DR*_ADDR_MASK, MSR_AMD64_LS_CFG, MSR_AMD64_DE_CFG, MSR_AMD64_BU_CFG2, MSR_AMD64_SYSCFG, MSR_AMD64_CPUID_FN_1, MSR_AMD64_CPUID_FN_7, MSR_AMD64_PATCH_LEVEL, MSR_VM_CR, MSR_AMD64_FP_CFG, MSR_ZEN2_SPECTRAL_CHICKEN, MSR_ZEN4_BP_CFG)
  - arch/x86/include/asm/cpufeatures.h (X86_FEATURE_ZEN1..6, SME/SEV/SEV_SNP, AUTOIBRS, ...)
  - arch/x86/include/asm/sev.h (snp_probe_rmptable_info)
-->

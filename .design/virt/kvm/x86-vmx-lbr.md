# Tier-3: arch/x86/kvm/vmx/pmu_intel.c (LBR subset) — Intel LBR (Last-Branch-Record) virtualization
...
upstream-paths:
  - arch/x86/kvm/vmx/pmu_intel.c (LBR-related sections; see grep "lbr|LBR|MSR_LBR")
  - arch/x86/kvm/vmx/vmx.c (LBR-related vmexit handling)
  - arch/x86/include/asm/perf_event.h (x86_pmu_lbr struct)
  - arch/x86/include/uapi/asm/msr-index.h (MSR_LASTBRANCH_*)
-->

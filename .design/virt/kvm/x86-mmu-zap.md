# Tier-3: arch/x86/kvm/mmu/mmu.c (zap subset) — KVM MMU SPTE invalidation (kvm_mmu_invalidate + zap_gfn_range + zap_all + mmu_valid_gen)
...
upstream-paths:
  - arch/x86/kvm/mmu/mmu.c (zap functions; see grep "kvm_zap|kvm_mmu_invalidate")
  - arch/x86/kvm/mmu/tdp_mmu.c (TDP MMU specific)
  - arch/x86/kvm/mmu/page_track.c (used by zap)
-->

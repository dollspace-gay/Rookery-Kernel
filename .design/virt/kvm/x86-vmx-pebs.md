# Tier-3: arch/x86/kvm/vmx/pmu_intel.c (PEBS subset) — Intel PEBS (Precise-Event-Based-Sampling) virtualization
...
upstream-paths:
  - arch/x86/kvm/vmx/pmu_intel.c (PEBS-related sections; see grep "pebs|MSR_IA32_DS_AREA|MSR_PEBS_DATA_CFG")
  - arch/x86/kvm/vmx/vmx.c (PEBS-related vmexit handling)
  - arch/x86/include/uapi/asm/msr-index.h (MSR_IA32_PEBS_*)
-->

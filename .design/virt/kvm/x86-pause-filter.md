# Tier-3: arch/x86/kvm/{vmx/vmx.c, svm/svm.c} (PLE / Pause-Filter subset) — KVM lock-holder yield via PAUSE-loop-exiting
...
upstream-paths:
  - arch/x86/kvm/vmx/vmx.c (PLE: ~174..199, ~1458..1490, handle_pause)
  - arch/x86/kvm/svm/svm.c (pause filter: control.pause_filter_count + control.pause_filter_thresh)
  - arch/x86/kvm/x86.c (kvm_vcpu_on_spin)

# Tier-3: arch/x86/kvm/x86.c (FPU subset) — KVM FPU/XSAVE virtualization (per-vCPU guest_fpu + XCR0 + XFD)
...
upstream-paths:
  - arch/x86/kvm/x86.c (FPU sections; see grep "kvm_load_guest_fpu|kvm_put_guest_fpu|guest_fpu|xfd_err|XCR0")
  - arch/x86/include/asm/fpu/api.h (kernel FPU API)
  - arch/x86/include/asm/fpu/types.h (struct fpu, struct fpstate)
  - arch/x86/include/uapi/asm/kvm.h (KVM_GET_XSAVE2 + KVM_GET_XCRS)
-->

# Tier-3: arch/x86/kvm/vmx/posted_intr.c — Intel VT-d Posted Interrupts (PI)
...
upstream-paths:
  - arch/x86/kvm/vmx/posted_intr.c (319 lines)
  - arch/x86/kvm/vmx/posted_intr.h (30 lines)
  - arch/x86/kvm/vmx/vmx.c (PI activation)

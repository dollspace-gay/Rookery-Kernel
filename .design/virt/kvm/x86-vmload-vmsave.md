# Tier-3: arch/x86/kvm/svm/svm.c (VMLOAD/VMSAVE subset) — AMD SVM VMLOAD / VMSAVE for additional state save/restore
...
upstream-paths:
  - arch/x86/kvm/svm/svm.c (vmload/vmsave; see grep "vmload|vmsave|host_save")
  - arch/x86/kvm/svm/vmenter.S (asm wrappers)
  - arch/x86/include/asm/svm.h (struct vmcb_save_area)
-->

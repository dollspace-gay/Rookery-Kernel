# Tier-3: arch/x86/kvm/vmx/tdx.c — Intel TDX (Trust Domain Extensions) confidential VM (TD-vCPU + TDH SEAMCALL + per-TD encrypted memory)
...
upstream-paths:
  ...
  - arch/x86/virt/vmx/tdx/tdx.c (TDX module driver - external)
-->

# Tier-3: arch/x86/kvm/vmx/vmx.c (EPTP subset) — VMX EPT-pointer construction + INVEPT semantics
...
upstream-paths:
  - arch/x86/kvm/vmx/vmx.c (EPTP subset: ~3279 construct_eptp, ~3305..3500, ~3498)
  - arch/x86/include/asm/vmx.h (EPT_POINTER VMCS field)
  - arch/x86/kvm/mmu/tdp_mmu.c (TDP MMU root linkage)
-->

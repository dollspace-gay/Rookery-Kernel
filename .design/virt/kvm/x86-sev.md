# Tier-3: arch/x86/kvm/svm/sev.c — KVM SEV (Secure Encrypted Virtualization) + SEV-ES + SEV-SNP confidential VMs
...
upstream-paths:
  ...
  - arch/x86/kvm/svm/svm.h (SEV fields)
  - drivers/crypto/ccp/sev-dev.c (PSP / Platform Secure Processor SEV-cmd dispatch; external)
  - include/uapi/linux/kvm.h (KVM_SEV_*)
-->

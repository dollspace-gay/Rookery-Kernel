# Tier-3: arch/x86/kvm/lapic.c (x2APIC subset) — x2APIC mode virtualization (32-bit APIC IDs + MSR-based access + MMIO-disable)
...
upstream-paths:
  - arch/x86/kvm/lapic.c (x2APIC sections; see grep "x2apic\|X2APIC")
  - arch/x86/kvm/lapic.h
  - arch/x86/kvm/vmx/vmx.c (x2APIC virtualization controls)
  - arch/x86/kvm/x86.c (MSR_IA32_APICBASE x2APIC bits)
-->

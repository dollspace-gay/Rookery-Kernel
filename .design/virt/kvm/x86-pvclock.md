# Tier-3: arch/x86/kvm/x86.c — kvmclock paravirt clock (per-vCPU pvclock-page + MSR_KVM_SYSTEM_TIME + WALL_CLOCK)
...
upstream-paths:
  - arch/x86/kvm/x86.c (kvmclock-related sections; see grep "kvmclock\|MSR_KVM_SYSTEM_TIME\|MSR_KVM_WALL_CLOCK")
  - arch/x86/include/asm/pvclock.h (UAPI pvclock_vcpu_time_info struct)
  - arch/x86/include/uapi/asm/kvm_para.h (MSR + CPUID definitions)

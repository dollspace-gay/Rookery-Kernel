# Tier-3: arch/x86/kvm/x86.c (CR0/CR4 subset) — Control-register virtualization (CR0/CR3/CR4 + paging-mode transitions + CR0/4 reserved-bits)
...
upstream-paths:
  - arch/x86/kvm/x86.c (CR0/CR4 sections; see grep "kvm_set_cr0|kvm_set_cr4|kvm_post_set_cr|cr0_guest_owned")
  - arch/x86/kvm/vmx/vmx.c (vmcs CR0_READ_SHADOW, CR0_GUEST_HOST_MASK)
  - arch/x86/kvm/svm/svm.c (vmcb cr0/cr4 fields)
-->

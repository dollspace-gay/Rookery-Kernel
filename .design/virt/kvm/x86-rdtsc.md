# Tier-3: arch/x86/kvm/x86.c (TSC subset) — KVM TSC virtualization (per-vCPU TSC offset + scaling + adjustment + clocksource)
...
upstream-paths:
  - arch/x86/kvm/x86.c (TSC sections; see grep "tsc_offset|adjust_tsc_offset|TSC_OFFSET|tsc_scaling|kvm_compute_l1_tsc")
  - arch/x86/kvm/vmx/vmx.c (VMCS TSC_OFFSET write)
  - arch/x86/kvm/svm/svm.c (VMCB TSC_OFFSET write)
  - arch/x86/include/uapi/asm/msr-index.h (MSR_IA32_TSC, MSR_IA32_TSC_ADJUST)
-->

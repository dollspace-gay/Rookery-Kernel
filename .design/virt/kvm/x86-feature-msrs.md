# Tier-3: arch/x86/kvm/x86.c (feature-MSR subset) — KVM feature-control MSR virtualization (MSR_IA32_ARCH_CAPABILITIES + MSR_IA32_FEAT_CTL + MSR_IA32_TSX_CTRL + MSR_IA32_FLUSH_CMD)
...
upstream-paths:
  - arch/x86/kvm/x86.c (feature-MSR sections; see grep "MSR_IA32_ARCH_CAPABILITIES|MSR_IA32_FEAT_CTL|kvm_get_arch_capabilities|TSX_CTRL")
  - arch/x86/include/asm/msr-index.h (MSR_IA32_ARCH_CAPABILITIES bits)
-->

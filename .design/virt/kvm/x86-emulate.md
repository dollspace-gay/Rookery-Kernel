# Tier-3: arch/x86/kvm/emulate.c — x86 instruction emulator (real-mode + 32-bit + invalid-guest-state recovery)
...
upstream-paths:
  ...
  - arch/x86/kvm/smm.c (uses emulator for some SMI paths)
-->

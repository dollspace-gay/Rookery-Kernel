# Tier-3: virt/kvm/binary_stats.c — KVM binary-stats interface (per-VM / per-vCPU statistics)
...
upstream-paths:
  - virt/kvm/binary_stats.c (~144 lines)
  - include/linux/kvm_host.h (kvm_stats_desc, kvm_stats_header)
  - include/uapi/linux/kvm.h (KVM_GET_STATS_FD + KVM_STATS_TYPE_*)
-->

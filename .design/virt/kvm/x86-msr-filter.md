# Tier-3: arch/x86/kvm/x86.c — KVM_X86_SET_MSR_FILTER (per-VM MSR access policy + userspace-routed MSR ioctls)
...
upstream-paths:
  - arch/x86/kvm/x86.c (kvm_msr_filter related sections; see grep "kvm_msr_filter|KVM_MSR_FILTER")
  - include/uapi/linux/kvm.h (KVM_X86_SET_MSR_FILTER + struct kvm_msr_filter)

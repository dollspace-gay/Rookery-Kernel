# Tier-3: arch/x86/kvm/vmx/vmenter.S — VMX vmenter assembly stub (host-state save + guest GPR-load + VMRESUME/VMLAUNCH + return-handler)
...
upstream-paths:
  ...
  - arch/x86/kvm/vmx/vmx.h (regs save area)
  - arch/x86/kvm/vmx/vmx_ops.h (low-level VMX ops)
-->

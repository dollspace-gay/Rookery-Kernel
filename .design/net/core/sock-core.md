# Tier-3: net/core/sock.c — struct sock allocation + per-protocol ops + sk_buff queue management + memory accounting

<!--
baseline-commit: 27a26ccfd528da725a999ea1e3102503c61eb655
baseline-version: 7.1.0-rc2
status: draft
parent: net/struct-sock.md
upstream-paths:
  - net/core/sock.c
  - include/net/sock.h
  - net/core/datagram.c (helper)
  - net/core/stream.c (helper)
-->

# Tier-3: net/ipv4/inet_connection_sock.c — Connection-oriented INET sockets (TCP, DCCP-removed, SCTP-shared bits)
...
upstream-paths:
  - net/ipv4/inet_connection_sock.c (~1563 lines)
  - include/net/inet_connection_sock.h
  - net/ipv4/tcp_ipv4.c (per-tcp consumer)
  - net/ipv4/tcp.c
-->

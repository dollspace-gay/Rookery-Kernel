# Tier-3: net/key/af_key.c — PF_KEY (KAME) key-management socket
...
upstream-paths:
  - net/key/af_key.c (~3953 lines)
  - include/uapi/linux/pfkeyv2.h (SADB_* opcodes, sadb_msg / sadb_ext_*)
  - net/xfrm/xfrm_state.c (state lookup / alloc bridge)
  - net/xfrm/xfrm_policy.c (policy lookup / dump bridge)
  - include/net/xfrm.h (xfrm_mgr, struct km_event)
-->

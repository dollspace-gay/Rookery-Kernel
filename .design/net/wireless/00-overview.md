# Tier-2: net/wireless — Wireless networking (cfg80211 + mac80211 + nl80211 UAPI + regulatory + per-driver iwlwifi/ath/mt76/rtw/brcmfmac/marvell/realtek)
...
(none at Tier-2 — defer to per-Tier-3 once Phase D begins; expected hot questions: TKIP allow vs deny default, WEP entirely-removal timeline, regulatory DB CRDA-userspace fallback default-on/off, mac80211_hwsim production-build inclusion, brcmfmac full-MAC vs mac80211 native-mode for shared chips)

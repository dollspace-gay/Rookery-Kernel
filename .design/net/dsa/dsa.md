# Tier-3: net/dsa/dsa.c — DSA (Distributed Switch Architecture) framework
...
upstream-paths:
  - net/dsa/dsa.c (~1900 lines)
  - net/dsa/conduit.c (CPU-port "conduit")
  - net/dsa/port.c
  - net/dsa/slave.c (user-facing ports)
  - net/dsa/devlink.c
  - net/dsa/{tag_*.c} (per-tag protocol)
  - include/net/dsa.h
-->

# Tier-3: net/9p/client.c — 9P client core (tag/fid/rpc/trans_mod)
...
upstream-paths:
  ...
  - net/9p/mod.c (trans_mod registry)
  - net/9p/protocol.c
  - net/9p/trans_fd.c (tcp/unix/fd)
  - net/9p/trans_virtio.c (virtio)
  - net/9p/trans_rdma.c (rdma)
  - net/9p/trans_xen.c (xen-9pfs)
  - net/9p/trans_usbg.c

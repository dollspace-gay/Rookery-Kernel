# Tier-3: net/netfilter/ipvs/ip_vs_core.c — IPVS (IP Virtual Server / LVS) L4 load-balancer
...
upstream-paths:
  - net/netfilter/ipvs/ip_vs_core.c (~2632 lines)
  - net/netfilter/ipvs/ip_vs_ctl.c
  - net/netfilter/ipvs/ip_vs_sync.c
  - net/netfilter/ipvs/ip_vs_conn.c
  - net/netfilter/ipvs/ip_vs_{rr, wrr, lc, wlc, lblc, sh, dh, fo, ovf, mh, sed, nq}.c
  - include/net/ip_vs.h

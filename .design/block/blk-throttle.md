# Tier-3: block/blk-throttle.c — Block IO throttling (cgroup blkio v1 + io.max v2)
...
upstream-paths:
  - block/blk-throttle.c (~1849 lines)
  - block/blk-throttle.h
  - block/blk-cgroup-rwstat.h
  - Documentation/admin-guide/cgroup-v2.rst (io.max)

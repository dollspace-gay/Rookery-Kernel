# Tier-3: io_uring/openclose.c — IORING_OP_OPENAT / OPENAT2 / CLOSE / FIXED_FD_INSTALL / FIXED_FD_REMOVE
...
upstream-paths:
  - io_uring/openclose.c (~448 lines)
  - io_uring/openclose.h
  - fs/open.c (do_file_open, build_open_how, build_open_flags)
  - fs/internal.h (delayed_filename, delayed_getname, filename_complete_delayed)
  - fs/file.c (__get_unused_fd_flags, fd_install, put_unused_fd, file_close_fd_locked, files_lookup_fd_locked)
  - fs/file_table.c (filp_close, receive_fd)
  - io_uring/filetable.c (io_fixed_fd_install, __io_fixed_fd_install, io_fixed_fd_remove)
  - include/uapi/linux/io_uring.h (IORING_OP_OPENAT/OPENAT2/CLOSE, IORING_FIXED_FD_NO_CLOEXEC, IORING_FILE_INDEX_ALLOC)
  - include/uapi/linux/openat2.h (struct open_how, OPEN_HOW_SIZE_VER0, RESOLVE_CACHED)
-->

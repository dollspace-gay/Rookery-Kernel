# Tier-3: io_uring/rsrc.c — io_uring resource registration (fixed files + buffers)
...
upstream-paths:
  - io_uring/rsrc.c (~1563 lines)
  - io_uring/rsrc.h
  - io_uring/filetable.{c,h}
  - include/uapi/linux/io_uring.h (IORING_REGISTER_FILES, _BUFFERS, _FILES_UPDATE, _BUFFERS_UPDATE, IORING_RSRC_FILE, IORING_RSRC_BUFFER, IORING_RSRC_REGISTER_SPARSE, IORING_REGISTER_FILES_SKIP, IORING_REGISTER_SRC_REGISTERED, IORING_REGISTER_DST_REPLACE, IORING_FILE_INDEX_ALLOC)
-->

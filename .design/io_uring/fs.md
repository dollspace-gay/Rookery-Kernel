# Tier-3: io_uring/fs.c — io_uring filesystem path operations (renameat / unlinkat / mkdirat / symlinkat / linkat)
...
upstream-paths:
  - io_uring/fs.c (~305 lines)
  - io_uring/fs.h
  - fs/internal.h (delayed_filename, delayed_getname, filename_*)
  - include/uapi/linux/io_uring.h (IORING_OP_RENAMEAT, UNLINKAT, MKDIRAT, SYMLINKAT, LINKAT)
-->

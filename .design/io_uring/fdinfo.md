# Tier-3: io_uring/fdinfo.c — /proc/<pid>/fdinfo for io_uring fds
...
upstream-paths:
  - io_uring/fdinfo.c (~271 lines)
  - io_uring/fdinfo.h
  - io_uring/sqpoll.h (io_sq_cpu_usec, struct io_sq_data)
  - include/linux/io_uring_types.h (struct io_ring_ctx, struct io_rings)
-->

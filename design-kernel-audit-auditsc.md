---
title: "Tier-3: kernel/auditsc.c — Syscall audit core (per-task audit_context + per-rule filter + per-record AUDIT_PATH/CWD/EXECVE/EOE/SOCKADDR/IPC/FD_PAIR/CONFIG_CHANGE)"

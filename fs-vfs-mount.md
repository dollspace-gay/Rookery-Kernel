---
title: "Tier-3: fs/vfs/mount — vfsmount, namespace, propagation, idmapped mounts"
...
- REQ-5: Propagation rules (shared / private / slave / unbindable) match upstream's algorithm:; When mounting on a shared mount, the new mount becomes shared with the parent; When mounting on a private mount, the new mount is private; When mounting on a slave mount, the new mount is slave to the parent's slave-master; Unbindable mounts cannot be bind-mounted
